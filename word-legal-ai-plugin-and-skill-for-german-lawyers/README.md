...
| Skill | Beschreibung |
| --- | --- |
| `anspruchsgrundlage-rechtsfolgen-b2b-vs` | Nutze dies, wenn Anspruchsgrundlage Und Rechtsfolgen Klauseln, B2B Vs B2C Klausel Strategie im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Anspruchsgrundlage Und Rechtsfolgen K... |
| `anwaltsschreiben-aussergerichtlich` | Nutze dies, wenn Anwaltsschreiben Aussergerichtlich, Argumentationsarchitektur Schreiben im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Anwaltsschreiben Aussergerichtlich, Argu... |
| `bedingungen-aufschiebend` | Nutze dies, wenn Workflow Fristen Und Risikoampel, Bedingungen Aufschiebend Aufloesend Fristen im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Workflow Fristen Und Risikoampel,... |
| `bilingual-drafting-cowork-cloud` | Nutze dies, wenn Bilingual Drafting Deutsch Englisch, Cowork Cloud Kollaboration Drafting im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Bilingual Drafting Deutsch Englisch, Co... |
| `bilinguales-writing-englische-vertraege` | Nutze dies, wenn Spezial Bilinguales Legal Writing, Spezial Englische Vertraege Deutsches Recht im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Spezial Bilinguales Legal Writing... |
| `boilerplate-klauseln-definitionen-klauseln` | Nutze dies, wenn Boilerplate Klauseln Katalog, Definitionen Klauseln Stringent im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Boilerplate Klauseln Katalog, Definitionen Klausel... |
| `defensive-drafting-deutscher-kanzleistil` | Nutze dies, wenn Defensive Drafting Fallen Erkennen, Deutscher Kanzleistil Kalibrieren im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Defensive Drafting Fallen Erkennen, Deutsc... |
| `dokumentarchitektur-vertrag-englischer` | Nutze dies, wenn Dokumentarchitektur Vertrag Und Schriftsatz, Englischer Vertrag Deutsches Recht im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Ich lade Unterlagen hoch.; Was fehlt n... |
| `dokumente-intake` | Nutze dies, wenn Dokumentenintake im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Ich lade Unterlagen hoch.; Was fehlt noch?; Bitte Dokumente sortieren.. |
| `drafting-prinzipien-finaler-writing` | Nutze dies, wenn Drafting Prinzipien Klarheit Bestimmtheit Praezision, Finaler Writing Quality Gate im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Drafting Prinzipien Klarheit... |
| `einstieg-routing` | Nutze dies, wenn Einstieg und Routing im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Ich habe ein neues Thema im Bereich Word Legal Ai Plugin And Skill For German Lawyers.; Welche Un... |
...
| `force-majeure-geheimhaltung-nda` | Nutze dies, wenn Force Majeure Und Erschwerung 313 Bgb, Geheimhaltung Nda Vertraulichkeit im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Force Majeure Und Erschwerung 313 Bgb,... |
| `german-agb-konforme` | Nutze dies, wenn Spezial German Fristen Form Und Zustaendigkeit, Agb Konforme Klauseln 305 310 Bgb im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Spezial German Fristen Form Un... |
| `gutachten-internes-ip-rechteuebertragung` | Nutze dies, wenn Gutachten Memo Internes Drafting, Ip Rechteuebertragung Und Lizenzen im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Gutachten Memo Internes Drafting, Ip Rechte... |
| `haftungsausschluss-haftungsbegrenzung` | Nutze dies, wenn Haftungsausschluss Und Haftungsbegrenzung, Klageerwiderung Substantiiertes Bestreiten im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Haftungsausschluss Und Haf... |
...
| `kaltstart-risikoampel-und-gegenargumente` | Nutze dies, wenn Kaltstart: Risikoampel, Gegenargumente und Verteidigungslinien im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Ich habe ein neues Thema im Bereich Word Legal Ai Plugi... |
| `klage-drafting-mandantenmemo-partner` | Nutze dies, wenn Klage Drafting 253 Zpo, Mandantenmemo Und Partner Update im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Klage Drafting 253 Zpo, Mandantenmemo Und Partner Updat... |
| `klausel-bibliothek-kuendigungsklauseln` | Nutze dies, wenn Klausel Bibliothek Katalog, Kuendigungsklauseln Und Vertragsbeendigung im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Klausel Bibliothek Katalog, Kuendigungskl... |
| `lawyers-legal` | Nutze dies, wenn Spezial Lawyers Dokumentenmatrix Und Lueckenliste, Spezial Legal Tatbestand Beweis Und Belege im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Spezial Lawyers Do... |
| `orientierung-drafting-partner-kommentar` | Nutze dies, wenn Orientierung Drafting Triage, Partner Kommentar Umsetzen im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Orientierung Drafting Triage, Partner Kommentar Umsetze... |
| `revisions-prozess-ueberarbeiten-richterlesbar` | Nutze dies, wenn Revisions Prozess Redlines Comparison, Schriftsatz Ueberarbeiten Richterlesbar im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Revisions Prozess Redlines Compar... |
| `term-sheet-vertragsstrafe-bgb` | Nutze dies, wenn Term Sheet Zu Vertrag Uebersetzung, Vertragsstrafe 339 Bgb im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Term Sheet Zu Vertrag Uebersetzung, Vertragsstrafe 33... |
| `transparenzgebot-bgb-us-uk` | Nutze dies, wenn Transparenzgebot 307 Bgb, Us Uk Legal Writing Für Deutsche im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Transparenzgebot 307 Bgb, Us Uk Legal Writing Für Deu... |
| `unterlagen-luecken` | Nutze dies, wenn Unterlagen und Lücken im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Ich lade Unterlagen hoch.; Was fehlt noch?; Bitte Dokumente sortieren.. |
| `verweis-querverweis-dokument-finish` | Nutze dies, wenn Verweis Und Querverweis Technik, Word Dokument Finish Und Layout im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Ich lade Unterlagen hoch.; Was fehlt noch?; Bitte Dok... |
| `word-stil-ton` | Nutze dies, wenn Spezial Word Erstpruefung Und Mandatsziel, Stil Und Ton Juristische Texte im Plugin Word Legal Ai Plugin And Skill For German Lawyers konkret bearbeitet werden soll. Auslöser: Bitte Spezial Word Erstpruefung Und Mandatsz... |
