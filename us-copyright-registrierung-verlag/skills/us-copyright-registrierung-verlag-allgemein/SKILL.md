---
name: us-copyright-registrierung-verlag-allgemein
...
Dieser Skill ist der Kaltstart für eine US-Copyright-Registrierung aus deutscher Verlagssicht. Er sortiert nicht nur eCO-Schritte, sondern die eigentlichen Weichen: Was ist das Werk, wer darf anmelden, welcher Antrag passt, welches Deposit ist geschuldet, wie wird bezahlt, was muss versandt werden und wie sieht die Verlagsakte danach aus.
...
- Erstelle zuerst eine **Werk- und Rechtekarte**: Titel, Ausgabe, Sprachfassung, Publication-Angaben, Claimant, Autorenschaft, ausgeschlossene Materialien.
- Trenne **Registrierung nach 17 U.S.C. § 408** von **Mandatory Deposit nach 17 U.S.C. § 407**. Beides kann praktisch zusammenfallen, ist aber nicht dasselbe.
- Entscheide den Antragstyp nicht nach Bequemlichkeit, sondern nach Zulässigkeit: Standard Application ist kein Sammelbecken für beliebig viele Werke.
- Baue eine Verlagsakte mit Case-Nummer, Zahlungsbeleg, Deposit-Nachweis, Shipping Slip, Tracking und Wiedervorlage.
- Markiere immer, welche Punkte live beim U.S. Copyright Office geprüft werden müssen, insbesondere Gebühren, Deposit-Formate, Gruppenoptionen und Bearbeitungszeiten.
