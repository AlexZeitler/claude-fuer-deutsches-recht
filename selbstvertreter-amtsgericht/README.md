...
| Skill | Beschreibung |
| --- | --- |
| `130a-zpo-fax-grenzen-mein-justizpostfach` | Nutze dies bei Einreichung 130a Zpo Elektronisch Buerger, Einreichung Fax Und Grenzen, Einreichung Mein Justizpostfach Mjp 2024: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastb... |
| `anfaenger-amtsgericht-rechtsprechungschat` | Nutze dies bei Anfaenger Amtsgericht, Rechtsprechungschat Amtsgericht, Fristbeginn Zustellung Protokollieren, Skill: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeits... |
| `anfaenger-workflow-amtsgericht` | Nutze dies bei Skill: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
...
| `anspruchsgrundlage-finden-anwaltszwang-zpo` | Nutze dies bei Anspruchsgrundlage Finden Laienhilfe, Anwaltszwang Prüfen 78 Zpo, Augenscheinsbeweis 371 Zpo: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
...
| `ausnahmen-streitwertgrenze-aussergerichtliche` | Nutze dies bei Ausnahmen Streitwertgrenze 23 Nr 2 Gvg, Aussergerichtliche Mahnung 286 Bgb, Beratungshilfe Aussergerichtlich Brh: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastb... |
...
| `berechnen-bgb-buch-fuehren-fristverlaengerung` | Nutze dies bei Fristen Berechnen 187 188 Bgb, Fristen Buch Fuehren Laien, Fristverlaengerung Antrag 225 Zpo: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
...
| `berufung-zpo-berufungs-zulassung-beweislast` | Nutze dies bei Berufung Amtsgericht 511 Zpo, Berufungs Zulassung Niedrig Streitwert, Beweislast Grundregel Wer Was: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitss... |
...
| `beweismittel-vorab-dokumenten-erzeugung` | Nutze dies bei Beweismittel Vorab Sammeln Checkliste, Dokumenten Erzeugung Pdf Laien Amtsgericht, Dolmetscher 185 Gvg: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbei... |
...
| `duplik-eidesstattliche-versicherung-einreden` | Nutze dies bei Duplik Nach Replik, Eidesstattliche Versicherung 294 Zpo, Einreden Aktiv Geltend Machen: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
...
| `kein-folgen-klage-streitwert-zusammenstellen` | Nutze dies bei Kein Beweis Folgen Laienwarnung, Klage Streitwert Angabe 3 Zpo, Klage Zusammenstellen Komplettes Bundle Amtsgericht: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten bela... |
...
| `klage-vereinfachtes-klageerwiderung-zpo` | Nutze dies bei Klage Vereinfachtes Verfahren 495a Zpo, Klageerwiderung Fristen 274 Zpo, Mahnverfahren 688 Ff Zpo Vor Klage: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren... |
...
| `klageerwiderung-checkliste-replik-anlagen` | Nutze dies bei Klageerwiderung Checkliste Alle Punkte, Klageerwiderung Replik Anlagen B1 B2 Fortlaufend, Klageschrift Anlagen Bezeichnen: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächste... |
...
| `klageerwiderung-replik-anlagen-b1-b2` | Anlagen-Nummerierung in Klageerwiderung und Replik korrekt fortführen. Beklagter nutzt B1 B2 B3. Klaeger nutzt in Replik K-Folge-Nummern ab Klage-Endnummer plus eins. Keine doppelten Nummern Querverweise zwischen Schriftsaetzen. Anlagenv... |
...
| `klageschrift-anschreiben-an-antrag-bestimmt` | Nutze dies bei Klageschrift Anschreiben An Gericht Laien, Klageschrift Antrag Bestimmt Formulieren, Klageschrift Beweisangebote Einbauen 373 Zpo: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den... |
...
| `klageschrift-pflichtbestandteile` | Nutze dies bei Klageschrift Pflichtbestandteile 253 Zpo, Klageschrift Tatsachenvortrag Strukturieren, Kostenfestsetzung 103 104 Zpo: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten bel... |
...
| `kostenrisiko-streitwert-ladung-termin` | Nutze dies bei Kostenrisiko Streitwert Berechnen Gkg, Ladung Termin 216 Zpo, Muendliche Verhandlung Akten Griffbereit: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbei... |
...
| `nachgereichter-296a-orientierung` | Nutze dies bei Nachgereichter Schriftsatz 296a Zpo, Orientierung Selbstvertreter Amtsgericht, Parteivernehmung 445 Ff Zpo: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren A... |
...
| `oertliche-zpo-online-verfahren` | Nutze dies bei Oertliche Zustaendigkeit 12 37 Zpo, Online Verfahren 11 Buch Zpo Experimentell, Rechtsmittelfrist 517 Zpo: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Ar... |
...
| `pkh-bewilligung-pkh-ratenzahlung` | Nutze dies bei Pkh Bewilligung Ablehnung Folgen, Pkh Ratenzahlung Bewilligung, Prozesskostenhilfe Pkh 114 Zpo: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
...
| `rechtsantragsstelle-selbst-gegnerische` | Nutze dies bei Einreichung Rechtsantragsstelle Selbst, Gegnerische Vollstreckung Abwehr, Gerichtskostenvorschuss 12 Gkg: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arb... |
...
| `replik-klageerwiderung-richterlicher-hinweis` | Nutze dies bei Replik Auf Klageerwiderung Systematik, Richterlicher Hinweis 139 Zpo Reaktion, Sachverstaendigenbeweis 402 Zpo: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbar... |
...
| `richtervorschlag-ii-verhalten-gerichtssaal` | Nutze dies bei Vergleich Richtervorschlag 278 Ii Zpo, Verhalten Gerichtssaal Laienleitfaden, Video Verhandlung 128a Zpo: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arb... |
| `sachliche-gvg-verjaehrungsfrist-bgb` | Nutze dies bei Sachliche Zustaendigkeit Amtsgericht 23 Gvg, Verjaehrungsfrist Prüfen 195 Bgb, Wiedereinsetzung Frist 233 Zpo: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbare... |
...
| `saeumnis-termin-vermeiden-sanity-check` | Nutze dies bei Saeumnis Im Termin 330 Zpo, Saeumnis Vermeiden 330 Ff Zpo, Sanity Check Selbstvertretung Amtsgericht, Zulassungsgrenzen Check Amtsgericht: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und lie... |
...
| `selbstvertreter-amtsgericht-allgemein` | Einstieg, Schnelltriage und Fallrouting im Selbstvertreter-Amtsgericht-Plugin. Fragt Erfahrungslevel, Rolle, Ziel, Fristen, Streitwert, Gericht, Unterlagen, Risiken und Wunsch-Output ab, schlägt passende Fachmodule aus diesem Plugin vor... |
...
| `substantiiertes-bestreiten-zerlegen` | Nutze dies bei Substantiiertes Bestreiten 138 Iv Zpo, Tatbestand Zerlegen Anspruchspruefung Laien, Terminvorbereitung Checkliste: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belast... |
...
| `typische-laien-urkundenbeweis-ff-urteil-zpo` | Nutze dies bei Typische Laien Fehler, Urkundenbeweis 415 Ff Zpo, Urteil Prüfen 313 Zpo: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
...
| `urteil-rechtskraft-urteilsverkuendung-zpo` | Nutze dies bei Urteil Rechtskraft 705 Zpo, Urteilsverkuendung 310 Zpo, Verbrauchergerichtsstand 29c Zpo: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
...
| `vollstreckungsklausel-zpo-papierform` | Nutze dies bei Vollstreckungsklausel 724 Zpo, Einreichung Papierform Mit Abschriften, Anlagen Formatieren K1 K2 Pdf Amtsgericht: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastb... |
...
| `vorabklaerung-erfolgsaussichten-wann-doch` | Nutze dies bei Vorabklaerung Erfolgsaussichten Selbstcheck, Wann Doch Anwalt Grenzfaelle, Widerklage 33 Zpo: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
...
| `zeugenbeweis-ff-zulassungsgrenzen-check` | Nutze dies bei Zeugenbeweis 373 Ff Zpo, Zulassungsgrenzen Check Amtsgericht, Zurechnungsproblem Versand Durch Dritte: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeit... |
...
| `zwangsvollstreckung-querverweis` | Nutze dies bei Zwangsvollstreckung Querverweis Substitutionsagent: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
