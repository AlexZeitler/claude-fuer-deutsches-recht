---
name: legistik-werkstatt-unterlagen-luecken
...
- **Fehlende Tatsache vs. fehlender Beleg.** Bei Legistik-Werkstatt (Gesetzgebung) oft fehlend: Referentenentwurf, Kabinettvorlage, BR-Drucksache.
- **Pro Lücke.** Beweisthema, Beweismittel (Folgenabschätzung, Stellungnahmen Verbände), Beschaffungsweg, Ersatznachweis.
- **Prioritätsregel.** Frist > Beweislast > materielle Voraussetzung > Taktik; konkret: Beteiligungsfristen.
- **Beschaffung extern.** BMJ (Akteneinsicht, Auskunft), Mandant (Originale), Dritte (Auskunftsverlangen).
- **Lücken offen ausweisen** im Mandantenmemo — niemals durch Pauschalformulierungen kaschieren.

## Output

Priorisierte Lückenliste mit Frist, Beweiszweck, Beschaffungsweg, Ersatznachweis und Verantwortlichem; im Mandat Legistik-Werkstatt (Gesetzgebung) typischerweise Referentenentwurf, Kabinettvorlage zuerst.
