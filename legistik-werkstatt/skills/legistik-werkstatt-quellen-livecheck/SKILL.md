---
name: legistik-werkstatt-quellen-livecheck
...
- **Tragende Normen amtlich.** Bei Legistik-Werkstatt (Gesetzgebung): GGO Bundesregierung, Handbuch der Rechtsförmlichkeit (HdR) — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** BMJ (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
