---
name: dfg-foerderantrag-einstieg-routing
...
- **Rolle und Ziel klären.** Wer fragt aus welcher Position (Antragsteller, DFG-Gutachter, Universitätsleitung) und welcher Output wird gebraucht?
- **Fristen zuerst.** Antragsfrist Ausschreibungstermin; Berichtspflichten jährlich.
- **Normenanker.** DFG-Verwendungsrichtlinien, Wissenschaftsfreiheit Art. 5 III GG. Tragende Norm vor Detail prüfen.
- **Zuständigkeit.** Deutsche Forschungsgemeinschaft / Universität — Verfahrens- und Verwaltungsweg trennen.
