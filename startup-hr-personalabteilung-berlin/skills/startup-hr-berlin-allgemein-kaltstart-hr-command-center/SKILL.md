---
name: startup-hr-berlin-allgemein-kaltstart-hr-command-center
...
- **Spezialgegenstand:** Allgemein Kaltstart HR Command Center wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
