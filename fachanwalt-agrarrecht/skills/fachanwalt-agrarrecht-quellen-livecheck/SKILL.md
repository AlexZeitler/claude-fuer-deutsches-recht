---
name: fachanwalt-agrarrecht-quellen-livecheck
...
- **Tragende Normen amtlich.** Bei Fachanwalt Agrarrecht: BLG, LwAnpG, GAP-Förderung — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** Landwirtschaftsbehörden Länder (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
