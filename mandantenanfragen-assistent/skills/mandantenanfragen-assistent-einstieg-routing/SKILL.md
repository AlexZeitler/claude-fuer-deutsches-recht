---
name: mandantenanfragen-assistent-einstieg-routing
...
- **Rolle und Ziel klären.** Wer fragt aus welcher Position (Mandant, Anwalt, Sekretariat) und welcher Output wird gebraucht?
- **Fristen zuerst.** Unverzügliche Antwort.
- **Normenanker.** BRAO § 43 Sachlichkeit, BORA. Tragende Norm vor Detail prüfen.
- **Eine Rückfrage maximal.** Nur fragen, was die nächste Weiche entscheidet.

## Output

Triage-Notiz mit Frist, Norm, Zuständigkeit, Anschluss-Skill-Vorschlag und konkret nächstem Schritt. Bei Mandantenanfragen-Assistent typische Eskalationsstufen: Antwortentwurf, Empfangsbestätigung, Rückfrage-Vorschlag.
