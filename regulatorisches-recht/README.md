...
| Skill | Beschreibung |
| --- | --- |
| `anschluss-router` | Nutze dies, wenn Allgemein, Workflow Anschluss Skills Router, Workflow Chronologie Und Belegmatrix im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser: Bitte Allgemein, Workflow Anschluss Skills Router, Workflow Chro... |
...
| `aufsichtsverfahren-anhoerung-gwg` | Nutze dies, wenn Spezial Aufsichtsverfahren Anhoerung Massnahme, Spezial Aufsichtsverfahren Formular Portal Und Einreichung, Spezial Gwg Fristen Form Und Zustaendigkeit im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Ausl... |
| `dokumente-intake` | Nutze dies, wenn Dokumentenintake im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser: Ich lade Unterlagen hoch.; Was fehlt noch?; Bitte Dokumente sortieren.. |
...
| `einstieg-routing` | Nutze dies, wenn Einstieg und Routing im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser: Ich habe ein neues Thema im Bereich Regulatorisches Recht.; Welche Unterlagen brauchen Sie?; Welcher Spezialskill passt?. |
| `enwg-feeds-heilmwerbg` | Nutze dies, wenn Spezial Enwg Dokumentenmatrix Und Lueckenliste, Spezial Feeds Compliance Dokumentation Und Akte, Spezial Heilmwerbg Risikoampel Und Gegenargumente im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser:... |
| `fristen-risikoampel-mandantenkommunikation` | Nutze dies, wenn Workflow Fristen Und Risikoampel, Workflow Mandantenkommunikation, Workflow Redteam Qualitygate im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser: Was kann hier schiefgehen?; Bitte red-team prüfen.... |
| `inkasso-massnahme-regulator` | Nutze dies, wenn Spezial Inkasso Verhandlung Vergleich Und Eskalation, Spezial Massnahme Mandantenkommunikation Entscheidungsvorlage, Spezial Regulator Zahlen Schwellen Und Berechnung im Plugin Regulatorisches Recht konkret bearbeitet we... |
| `inkasso-rdg-luecken-mar-mifid` | Nutze dies, wenn Inkasso Rdg, Luecken, Mar Mifid Eltif Uebergreifend im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser: Bitte Inkasso Rdg, Luecken, Mar Mifid Eltif Uebergreifend prüfen.; Erstelle eine Arbeitsfassun... |
| `interview-fristennotiz-aufsichtssanktion` | Nutze dies, wenn Spezial Interview Fristennotiz Und Naechster Schritt, Aufsichtssanktion Revision Spezial, Spezial Umsatzsteuer Behörden Gericht Und Registerweg im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser: Bi... |
...
| `output-waehlen` | Nutze dies, wenn Output wählen im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser: Bitte Output wählen prüfen.; Erstelle eine Arbeitsfassung zu Output wählen.; Welche Normen und Nachweise brauche ich?. |
| `quellen-livecheck` | Nutze dies, wenn Rechtsquellen-Livecheck im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser: Welche amtliche Quelle prüfe ich zuerst?; Gibt es aktuelle Rechtsprechung?; Bitte Fundstellen verifizieren.. |
| `rdg-quellenkarte` | Nutze dies, wenn Rdg Quellenkarte im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser: Welche amtliche Quelle prüfe ich zuerst?; Gibt es aktuelle Rechtsprechung?; Bitte Fundstellen verifizieren.. |
| `regr-dora-resilienz` | Nutze dies, wenn Regr Dora Resilienz Spezial, Regr Finanzdienstleistungsregulierung Bauleiter, Regr Mica Kryptoassets Spezial im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser: Bitte Regr Dora Resilienz Spezial, Re... |
| `regr-mifid2-regrecht-einfuehrung-internal` | Nutze dies, wenn Regr Mifid2 Mar Leitfaden, Regrecht Einfuehrung Sektoren, Regrecht Internal Policies Design im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser: Bitte Regr Mifid2 Mar Leitfaden, Regrecht Einfuehrung... |
...
| `regulatorisches-richtlinien-neufassung` | Nutze dies, wenn Regulatorisches Recht Anpassen, Regulatorisches Recht Mandat Arbeitsbereich, Richtlinien Neufassung im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser: Bitte Regulatorisches Recht Anpassen, Regulato... |
| `regulatorisches-stellungnahmen-beweislast` | Nutze dies, wenn Spezial Regulatorisches Internationaler Bezug Und Schnittstellen, Spezial Stellungnahmen Beweislast Und Darlegungslast, Spezial Voranmeldung Schriftsatz Brief Und Memo Bausteine im Plugin Regulatorisches Recht konkret be... |
| `richtlinien-anhoerung-red-aufsichtsrecht` | Nutze dies, wenn Richtlinien Vergleich, Spezial Anhoerung Red Team Und Qualitaetskontrolle, Spezial Aufsichtsrecht Erstpruefung Und Mandatsziel im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser: Was kann hier schie... |
| `sonderfall-edge-case` | Nutze dies, wenn Kaltstart: Sonderfall und Edge-Case-Prüfung im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser: Ich habe ein neues Thema im Bereich Regulatorisches Recht.; Welche Unterlagen brauchen Sie?; Welcher S... |
| `unterlagen-luecken` | Nutze dies, wenn Unterlagen und Lücken im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser: Ich lade Unterlagen hoch.; Was fehlt noch?; Bitte Dokumente sortieren.. |
| `ustva-aufsichtskommunikation-grundregeln-dora` | Nutze dies, wenn Ustva, Aufsichtskommunikation Grundregeln, Dora Stellvertreter Und Konzern im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser: Bitte Ustva, Aufsichtskommunikation Grundregeln, Dora Stellvertreter Un... |
| `wochendigest-interessen-wphg-stellungnahmen` | Nutze dies, wenn Spezial Wochendigest Mehrparteien Konflikt Und Interessen, Spezial Wphg Tatbestand Beweis Und Belege, Stellungnahmen im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser: Bitte Spezial Wochendigest Me... |
| `wpig-zag` | Nutze dies, wenn Wpig Und Zag Prüfung im Plugin Regulatorisches Recht konkret bearbeitet werden soll. Auslöser: Bitte Wpig Und Zag Prüfung prüfen.; Erstelle eine Arbeitsfassung zu Wpig Und Zag Prüfung.; Welche Normen und Nachweise brauch... |
