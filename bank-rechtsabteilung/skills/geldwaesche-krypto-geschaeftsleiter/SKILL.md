...
description: "Nutze dies, wenn Geldwaesche Krypto Wallet Screening, Geschaeftsleiter Abberufung Krise, Geschaeftsleiter Bestellung Kwg Zag, Girokonto Firmenkunden Risk Exit, Gwg Aml Kyc Verdachtsmeldung im Plugin Bank Rechtsabteilung konkret bearbeitet werden soll. Auslöser: Bitte Geldwaesche Krypto Wallet Screening, Geschaeftsleiter Abberufung Krise, Geschaeftsleiter Bestellung Kwg Zag, Girokonto Firmenkunden Risk Exit, Gwg Aml Kyc Verdachtsmeldung prüfen.; Erstelle eine Arbeitsfassung zu Geldwaesche Krypto Wallet Screening, Geschaeftsleiter Abberufung Krise, Geschaeftsleiter Bestellung Kwg Zag, Girokonto Firmenkunden Risk Exit, Gwg Aml Kyc Verdachtsmeldung.; Welche Normen und Nachweise brauche ich?."
---

# Geldwaesche Krypto Wallet Screening, Geschaeftsleiter Abberufung Krise, Geschaeftsleiter Bestellung Kwg Zag, Girokonto Firmenkunden Risk Exit, Gwg Aml Kyc Verdachtsmeldung
...
- **Spezialgegenstand:** Krypto-AML Wallet Screening; dieser Skill beginnt mit der Sachfrage und liefert eine konkrete Lösung statt bloßer Orientierung.
...
- **Spezialgegenstand:** Geschäftsleiterabberufung und Krise; dieser Skill beginnt mit der Sachfrage und liefert eine konkrete Lösung statt bloßer Orientierung.
- **Normen-/Quellenanker:** KWG, ZAG, WpHG, WpIG, MaRisk/BAIT-DORA-Schnittstellen, BGB/AGB, HGB, GwG, BaFin-Praxis, Sanierung/InsO/StaRUG.
- **Entscheidende Weiche:** Bankgeschäft, Erlaubnis, Vorstandsvorlage, Risikoappetit, Kundenschutz, Sicherheiten, Aufsichtskommunikation und externe Kanzleisteuerung trennen.
- **Arbeitsprodukt:** Erzeuge eine konkrete Prüf- oder Entscheidungsmatrix mit Norm, Tatbestand, Beleg, Einwand, Risikoampel und nächstem Schritt; Anschluss-Skills nur bei echter Vertiefung nennen.
...
- **Spezialgegenstand:** Firmenkunden Risk Exit; dieser Skill beginnt mit der Sachfrage und liefert eine konkrete Lösung statt bloßer Orientierung.
- **Normen-/Quellenanker:** KWG, ZAG, WpHG, WpIG, MaRisk/BAIT-DORA-Schnittstellen, BGB/AGB, HGB, GwG, BaFin-Praxis, Sanierung/InsO/StaRUG.
- **Entscheidende Weiche:** Bankgeschäft, Erlaubnis, Vorstandsvorlage, Risikoappetit, Kundenschutz, Sicherheiten, Aufsichtskommunikation und externe Kanzleisteuerung trennen.
- **Arbeitsprodukt:** Erzeuge eine konkrete Prüf- oder Entscheidungsmatrix mit Norm, Tatbestand, Beleg, Einwand, Risikoampel und nächstem Schritt; Anschluss-Skills nur bei echter Vertiefung nennen.
...
- **Spezialgegenstand:** GwG AML KYC; dieser Skill beginnt mit der Sachfrage und liefert eine konkrete Lösung statt bloßer Orientierung.
- **Normen-/Quellenanker:** KWG, ZAG, WpHG, WpIG, MaRisk/BAIT-DORA-Schnittstellen, BGB/AGB, HGB, GwG, BaFin-Praxis, Sanierung/InsO/StaRUG.
- **Entscheidende Weiche:** Bankgeschäft, Erlaubnis, Vorstandsvorlage, Risikoappetit, Kundenschutz, Sicherheiten, Aufsichtskommunikation und externe Kanzleisteuerung trennen.
- **Arbeitsprodukt:** Erzeuge eine konkrete Prüf- oder Entscheidungsmatrix mit Norm, Tatbestand, Beleg, Einwand, Risikoampel und nächstem Schritt; Anschluss-Skills nur bei echter Vertiefung nennen.
