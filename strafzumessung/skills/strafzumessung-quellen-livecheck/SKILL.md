---
name: strafzumessung-quellen-livecheck
...
- **Tragende Normen amtlich.** Bei Strafzumessung: § 46 StGB, §§ 47-50 StGB Strafmilderung/-schärfung, BGH-Strafzumessungsleitlinien — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** Strafgericht (Amts-/Landgericht) (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
