---
name: europarecht-kompass-quellen-livecheck
...
- **Tragende Normen amtlich.** Bei Europarecht-Kompass: AEUV/EUV, EU-Grundrechtecharta, Sekundärrecht (VO/RL) — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** EuGH (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
