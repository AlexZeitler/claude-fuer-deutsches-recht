---
name: forderungsmanagement-klagewerkstatt-output-waehlen
...
- **Zweck zuerst.** Bei Forderungsmanagement Klagewerkstatt typische Outputs: Mahnung, Mahnbescheid online (zentrales MB-Gericht), Klage, Vollstreckungsantrag.
- **Adressat bestimmt Ton.** Mandant (klar, Sie-Form) / Gegner (Schuldner, sachlich) / Behörde/Gericht (AG Mahngericht (zentral), formal, mit Norm- und Az-Angabe).
- **Frist und Form** der Außenkommunikation beachten: Mahnbescheid-Widerspruch 2 Wochen.
