...
- **Zweck zuerst.** Bei Anlagen zu Schriftsätzen typische Outputs: Anlagenverzeichnis K/B-Nummerierung, Anlagenkonvolut, Schwärzungsanleitung, Übersetzungshinweise.
- **Adressat bestimmt Ton.** Mandant (klar, Sie-Form) / Gegner (Gegenpartei, sachlich) / Behörde/Gericht (Zivilgerichte, formal, mit Norm- und Az-Angabe).
- **Frist und Form** der Außenkommunikation beachten: Klageerwiderungsfrist.
...
Format-Wahl mit kurzer Begründung, einer Alternative und fertigem Bausteinen; bei Anlagen zu Schriftsätzen sofort: Anlagenverzeichnis K/B-Nummerierung oder Anlagenkonvolut.
