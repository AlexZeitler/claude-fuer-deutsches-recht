---
name: schriftform-und-textform-bgb-unterlagen-luecken
...
- **Fehlende Tatsache vs. fehlender Beleg.** Bei Schriftform/Textform BGB oft fehlend: Vertrag, Unterschrift, qualifizierte e-Signatur.
- **Pro Lücke.** Beweisthema, Beweismittel (Empfangsbestätigung, Versandbeleg), Beschaffungsweg, Ersatznachweis.
- **Prioritätsregel.** Frist > Beweislast > materielle Voraussetzung > Taktik; konkret: Form vor Wirksamkeit.
...
Priorisierte Lückenliste mit Frist, Beweiszweck, Beschaffungsweg, Ersatznachweis und Verantwortlichem; im Mandat Schriftform/Textform BGB typischerweise Vertrag, Unterschrift zuerst.
