---
name: dsa-dma-digitalregulierung-anschluss-routing
...
- **Engpass zuerst.** Bei DSA/DMA Digitalregulierung typischer Engpass: DSA Risikoberichte jährlich oder AGB.
- **Skill-Auswahl** nach Sachverhalt, Rolle (Plattform/VLOP, Nutzer), Frist und gewünschtem Output.
