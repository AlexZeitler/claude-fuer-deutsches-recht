---
name: jurastudium-einstieg-routing
...
- **Rolle und Ziel klären.** Wer fragt aus welcher Position (Studierender, Repetitor, Korrektor) und welcher Output wird gebraucht?
- **Fristen zuerst.** Klausurzeit; Hausarbeitsfristen.
- **Normenanker.** BGB, StGB, GG, ZPO/StPO/VwGO. Tragende Norm vor Detail prüfen.
- **Zuständigkeit.** Universität / Justizprüfungsamt — Verfahrens- und Verwaltungsweg trennen.
