---
name: jurastudium-quellen-livecheck
...
- **Tragende Normen amtlich.** Bei Jurastudium (Klausur, AG, Examen): BGB, StGB, GG, ZPO/StPO/VwGO — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** Universität (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
