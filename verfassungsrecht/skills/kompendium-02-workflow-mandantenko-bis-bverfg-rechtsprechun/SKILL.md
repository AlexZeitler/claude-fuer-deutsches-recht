---
name: kompendium-02-workflow-mandantenko-bis-bverfg-rechtsprechun
description: "verfassungsrecht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Mandantenkommunikation, Redteam Qualitygate, Bverfg Rechtsprechung Recherchieren; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck."
---

# Arbeitsbereich - Mandantenkommunikation, Redteam Qualitygate, Bverfg Rechtsprechung Recherchieren
...
## Aufgabe
Dieser Workflow-Skill für `verfassungsrecht` Mandantenkommunikation im Plugin verfassungsrecht: übersetzt das Ergebnis in eine klare Nachricht mit Entscheidungspunkten, Risiken und nächsten Schritten.. Er ist dazu da, den Nutzer schneller und sicherer in die richtige Bearbeitung zu führen.
...
## Aufgabe
Dieser Workflow-Skill für `verfassungsrecht` Red-Team Qualitygate im Plugin verfassungsrecht: prüft das Ergebnis auf Halluzinationen, Fristenfehler, Zuständigkeit, Quellen, Beweise und Ton.. Er ist dazu da, den Nutzer schneller und sicherer in die richtige Bearbeitung zu führen.
