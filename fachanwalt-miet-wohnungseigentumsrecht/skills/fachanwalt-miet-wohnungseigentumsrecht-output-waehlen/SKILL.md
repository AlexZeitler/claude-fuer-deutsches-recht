---
name: fachanwalt-miet-wohnungseigentumsrecht-output-waehlen
...
- **Zweck zuerst.** Bei Fachanwalt Miet- und Wohnungseigentumsrecht typische Outputs: Kündigung, Beschlussklage WEG, Mieterhöhungsklage, Mangelklage.
- **Adressat bestimmt Ton.** Mandant (klar, Sie-Form) / Gegner (Vermieter, sachlich) / Behörde/Gericht (Amtsgericht Belegenheit (Miete + WEG), formal, mit Norm- und Az-Angabe).
- **Frist und Form** der Außenkommunikation beachten: § 573c BGB Kündigung.
