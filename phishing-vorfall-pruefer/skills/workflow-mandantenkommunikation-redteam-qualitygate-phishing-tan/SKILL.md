---
name: workflow-mandantenkommunikation-redteam-qualitygate-phishing-tan
description: "Workflow Mandantenkommunikation, Workflow Redteam Qualitygate, Phishing Tan Verfahren Vergleich: Workflow Mandantenkommunikation; Workflow Redteam Qualitygate; Phishing Tan Verfahren Vergleich. Führt Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck zusammen."
---

# Workflow Mandantenkommunikation, Workflow Redteam Qualitygate, Phishing Tan Verfahren Vergleich
...
## Aufgabe
Dieser Workflow-Skill für `phishing-vorfall-pruefer` Mandantenkommunikation im Plugin phishing-vorfall-pruefer: übersetzt das Ergebnis in eine klare Nachricht mit Entscheidungspunkten, Risiken und nächsten Schritten.. Er ist dazu da, den Nutzer schneller und sicherer in die richtige Bearbeitung zu führen.
