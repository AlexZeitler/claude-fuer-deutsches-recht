...
| `kompendium-01-allgemein-bis-workflow-chronologie` | kanzlei-builder-hub: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Allgemein, Anschluss Skills Router, Chronologie Und Belegmatrix; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck. |
| `kompendium-02-workflow-fristen-und-bis-workflow-redteam-qua` | kanzlei-builder-hub: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Fristen Und Risikoampel, Mandantenkommunikation, Redteam Qualitygate; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitäts... |
| `kompendium-03-spezial-community-fr-bis-automatischer-aktual` | kanzlei-builder-hub: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Community Fristen Form Und Zustaendigkeit, Leistungsmatrix Fristennotiz Und Naechster Schritt, Automatischer Aktualisierer; mit Intake, Prüfroutine, Normen-... |
| `kompendium-04-builder-uebersicht-f-bis-deinstallieren` | kanzlei-builder-hub: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Builder Uebersicht Fuer Einsteiger, Deaktivieren, Deinstallieren; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck. |
| `kompendium-05-grosskanzlei-rollout-bis-kanzlei-prozesse-abb` | kanzlei-builder-hub: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Grosskanzlei Rollout Spezial, Kanzlei Builder Hub Anpassen, Kanzlei Prozesse Abbilden; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmus... |
| `kompendium-06-khub-kanzlei-coi-kon-bis-khub-leistungsmatrix` | kanzlei-builder-hub: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Khub Kanzlei Coi Konfliktmatrix Spezial, Khub Kanzlei Onboarding Bauleiter, Khub Leistungsmatrix Mandanten Checkliste; mit Intake, Prüfroutine, Normen-/Quel... |
| `kompendium-07-khub-mandantenkonfer-bis-rentier-rechtsanwalt` | kanzlei-builder-hub: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Khub Mandantenkonferenz Templates Spezial, Paralegal Rollen Automatisieren, Rentier Rechtsanwalt Spezial; mit Intake, Prüfroutine, Normen-/Quellenradar, Bew... |
| `kompendium-08-skill-qa-kanzleiweit-bis-skill-verwalter` | kanzlei-builder-hub: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Skill Qa Kanzleiweit Spezial, Skill Templating Praxis, Skill Verwalter; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitä... |
| `kompendium-09-skills-qualitaetspru-bis-spezial-daten-red-te` | kanzlei-builder-hub: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Skills Qualitaetspruefung, Builder Zahlen Schwellen Und Berechnung, Daten Red Team Und Qualitaetskontrolle; mit Intake, Prüfroutine, Normen-/Quellenradar, B... |
| `kompendium-10-spezial-deployment-s-bis-spezial-einsteiger-m` | kanzlei-builder-hub: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Deployment Schriftsatz Brief Und Memo Bausteine, Eigenen Formular Portal Und Einreichung, Einsteiger Mandantenkommunikation Entscheidungsvorlage; mit Intake... |
| `kompendium-11-spezial-findet-erstp-bis-spezial-installiert` | kanzlei-builder-hub: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Findet Erstpruefung Und Mandatsziel, Gate Behoerden Gericht Und Registerweg, Installiert Tatbestand Beweis Und Belege; mit Intake, Prüfroutine, Normen-/Quel... |
| `kompendium-12-spezial-kanzleiumgeb-bis-spezial-livecheck-me` | kanzlei-builder-hub: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Kanzleiumgebung Verhandlung Vergleich Und Eskalation, Khub Sonderfall Und Edge Case, Livecheck Mehrparteien Konflikt Und Interessen; mit Intake, Prüfroutine... |
| `kompendium-13-spezial-playbook-int-bis-spezial-review-risik` | kanzlei-builder-hub: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Playbook Internationaler Bezug Und Schnittstellen, Qualitaetspruefung Beweislast Und Darlegungslast, Review Risikoampel Und Gegenargumente; mit Intake, Prüf... |
| `kompendium-14-spezial-security-dok-bis-spezial-skill-instal` | kanzlei-builder-hub: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Security Dokumentenmatrix Und Lueckenliste, Skill Installation Security Gate; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Q... |
