---
name: fachanwalt-sportrecht-quellen-livecheck
...
- **Tragende Normen amtlich.** Bei Fachanwalt Sportrecht: Verbandsrecht (DFB, DOSB), CAS-Code, WADA-Code — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** Verbandsschiedsgerichte (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
