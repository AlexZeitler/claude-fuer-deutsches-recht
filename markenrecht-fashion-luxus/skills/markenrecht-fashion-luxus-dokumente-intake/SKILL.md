---
name: markenrecht-fashion-luxus-dokumente-intake
...
- **Sortieren nach Dokumenttyp.** Bei Markenrecht Fashion/Luxus typisch: Markenregisterauszug, Lizenzvertrag, Abmahnung, Verkehrsbefragung.
- **Datum, Absender, Empfänger, Aktenzeichen** je Dokument; Fristwirkung markieren (Widerspruch 3 Monate § 42 MarkenG, Verlängerung 10 Jahre).
- **Beweiswert einordnen.** Verkehrsbefragung Verkehrsgeltung, Benutzungsnachweis jeweils mit Tatsachenbezug.
- **Berufsrecht.** Mandatsgeheimnis (§ 43a BRAO, § 203 StGB), DSGVO bei externer Verarbeitung; keine sensiblen Klartextdaten in Tools ohne AVV.
- **Lücken markieren** — nicht still überlesen; jede Lücke wird Arbeitsauftrag.

## Output

Dokumentenregister mit K/B-Nummerierung, Chronologie, Beweiswerttabelle und Rückfrageliste an Markeninhaber.
