...
description: "Erbvo: Livequellen- und Rechtsprechungscheck im Erbrecht: fachlich vertiefter Spezialskill mit Normenradar (BGB/FamFG/EuErbVO), Tatbestands-/Beweislastmatrix, Fristen- und Formcheck, Gegenargumenten, Fehlerbremse und direkt nutzbarem Arbeitsprodukt."
---

# Erbvo: Livequellen- und Rechtsprechungscheck

## Fachlicher Kern — Erbrecht
- **Problemfokus dieses Skills:** Bleibe beim konkreten Titel `Erbvo: Livequellen- und Rechtsprechungscheck` und löse die dort angelegte Fachfrage; keine Flucht in allgemeines Routing, außer eine echte Frist oder Zuständigkeit ist unklar.
...
## Spezialwissen: Erbvo: Livequellen- und Rechtsprechungscheck
- **Spezialgegenstand:** Erbvo: Livequellen- und Rechtsprechungscheck / spezial erbvo livequellen und rechtsprechungscheck. Der Skill löst diese konkrete Lage und darf nicht in allgemeines Routing ausweichen.
