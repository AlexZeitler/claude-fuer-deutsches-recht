...
description: "Rechtsquellen: Red-Team und Qualitätskontrolle im Erbrecht: fachlich vertiefter Spezialskill mit Normenradar (BGB/FamFG/EuErbVO), Tatbestands-/Beweislastmatrix, Fristen- und Formcheck, Gegenargumenten, Fehlerbremse und direkt nutzbarem Arbeitsprodukt."
---

# Rechtsquellen: Red-Team und Qualitätskontrolle

## Fachlicher Kern — Erbrecht
- **Problemfokus dieses Skills:** Bleibe beim konkreten Titel `Rechtsquellen: Red-Team und Qualitätskontrolle` und löse die dort angelegte Fachfrage; keine Flucht in allgemeines Routing, außer eine echte Frist oder Zuständigkeit ist unklar.
...
## Spezialwissen: Rechtsquellen: Red-Team und Qualitätskontrolle
- **Spezialgegenstand:** Rechtsquellen: Red-Team und Qualitätskontrolle / spezial rechtsquellen red team und qualitaetskontrolle. Der Skill löst diese konkrete Lage und darf nicht in allgemeines Routing ausweichen.
