---
name: mittelstand-corporate-ma-versand-signing
...
- **Spezialgegenstand:** Output, Signing und Versand wird als eigener Falltyp behandelt; der Skill muss ein konkretes Ergebnis liefern, nicht nur Einstieg und Routing.
