...
- **Tragende Normen amtlich.** Bei Tabellenreview (Excel/CSV): GoBD, Tax compliance — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** Finanzamt (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
