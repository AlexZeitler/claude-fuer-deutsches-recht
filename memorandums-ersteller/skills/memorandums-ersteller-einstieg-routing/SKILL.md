...
- **Rolle und Ziel klären.** Wer fragt aus welcher Position (Mandant, Geschäftsleitung, Aufsichtsorgan) und welcher Output wird gebraucht?
- **Fristen zuerst.** Mandantenbericht-Fristen.
- **Normenanker.** Anwendungsbereich nach Mandat. Tragende Norm vor Detail prüfen.
- **Eine Rückfrage maximal.** Nur fragen, was die nächste Weiche entscheidet.

## Output

Triage-Notiz mit Frist, Norm, Zuständigkeit, Anschluss-Skill-Vorschlag und konkret nächstem Schritt. Bei Memorandum-Ersteller typische Eskalationsstufen: Memo im Gutachtenstil, Executive Summary, Risikomatrix.
