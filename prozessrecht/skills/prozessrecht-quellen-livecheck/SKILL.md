...
- **Tragende Normen amtlich.** Bei Prozessrecht (ZPO/VwGO/StPO/SGG): ZPO, VwGO, StPO, SGG, FGO, FamFG — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** Erste Instanz / Rechtsmittelgerichte (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
