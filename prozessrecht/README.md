...
| `kompendium-01-allgemein-bis-workflow-fristen-und` | prozessrecht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Allgemein, Chronologie Und Belegmatrix, Fristen Und Risikoampel; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck. |
| `kompendium-02-amtlicher-zpo-verfah-bis-spezial-eilverfahren` | prozessrecht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Amtlicher Zpo Verfahrenscheck, Proz Zustaendigkeit Bauleiter, Eilverfahren Risikoampel Und Gegenargumente; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislog... |
| `kompendium-03-spezial-fristen-fris-bis-spezial-zustaendigke` | prozessrecht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Fristen Fristen Form Und Zustaendigkeit, Verfahrensart Rechtsweg Zustaendigkeit, Zustaendigkeit Zahlen Schwellen Und Berechnung; mit Intake, Prüfroutine, Normen-/Q... |
| `kompendium-04-mahnschreiben-entwur-bis-argumentationsverbes` | prozessrecht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Mahnschreiben Entwurf, Anwaltsgeheimnis Pruefung, Argumentationsverbesserung Red Team; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und... |
| `kompendium-05-beweissicherung-bis-einstweilige-verfueg` | prozessrecht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Beweissicherung, Chronologie, Einstweilige Verfuegung; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck. |
| `kompendium-06-gegenseite-status-bis-mahnschreiben-aufnah` | prozessrecht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Gegenseite Status, Mahnbescheid, Mahnschreiben Aufnahme; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck. |
| `kompendium-07-mahnschreiben-erhalt-bis-mandat-aufnahme` | prozessrecht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Mahnschreiben Erhalten, Mandat Aktualisierung, Mandat Aufnahme; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck. |
| `kompendium-08-mandat-briefing-bis-portfolio-status` | prozessrecht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Mandat Briefing, Mandat Schliessen, Portfolio Status; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck. |
| `kompendium-09-proz-beweismittel-le-bis-proz-prozessfinanzie` | prozessrecht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Proz Beweismittel Leitfaden, Proz Mediationsklage Guete Spezial, Proz Prozessfinanzierung Spezial; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outp... |
| `kompendium-10-prozessrecht-anpasse-bis-schriftsatz-abschnit` | prozessrecht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Prozessrecht Anpassen, Prozessrecht Mandat Arbeitsbereich, Schriftsatz Abschnitt; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qual... |
| `kompendium-11-spezial-anspruchstab-bis-spezial-mahnbescheid` | prozessrecht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Anspruchstabelle Compliance Dokumentation Und Akte, Gegenseite Mehrparteien Konflikt Und Interessen, Mahnbescheid Dokumentenmatrix Und Lueckenliste; mit Intake, Pr... |
| `kompendium-12-spezial-mandat-formu-bis-spezial-prozessrecht` | prozessrecht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Mandat Formular Portal Und Einreichung, Mandate Tatbestand Beweis Und Belege, Prozessrecht Verhandlung Vergleich Und Eskalation; mit Intake, Prüfroutine, Normen-/Q... |
| `kompendium-13-spezial-prozessrecht-bis-spezial-status-inter` | prozessrecht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Prozessrechtliche Erstpruefung Und Mandatsziel, Schriftsaetze Schriftsatz Brief Und Memo Bausteine, Status Internationaler Bezug Und Schnittstellen; mit Intake, Pr... |
| `kompendium-14-spezial-vollstreckun-bis-strafverteidigung-er` | prozessrecht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Vollstreckung Behoerden Gericht Und Registerweg, Stpo Biometrischer Internetabgleich Und Ki Ermittlung, Strafverteidigung Ersttermin; mit Intake, Prüfroutine, Norm... |
| `kompendium-15-streitwert-bis-vollstreckung` | prozessrecht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Streitwert, Verkehrsunfall, Vollstreckung; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck. |
| `kompendium-16-vorlageanordnung-bis-zeuge-vorbereitung` | prozessrecht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Vorlageanordnung, Zeuge Vorbereitung; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck. |
