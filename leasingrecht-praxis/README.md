...
| Skill | Beschreibung |
| --- | --- |
| `allgemein` | Leasingrecht Praxis: eleganter Kaltstart, Aktenlandkarte, Spezialskill-Routing, Quellenhygiene und erste verwertbare Ausgabe. |
| `lease-001-kaltstart-leasingakte-vertrag-objekt-zahlungsstrom` | Schnellanalyse einer Leasingakte: Vertragstyp, Objekt, Zahlungsstrom und Eigentumslage klären; strukturierter Einstieg mit Normencheck und Sofortmaßnahmen. |
