---
name: normenkontrolle-bauleitplanung-quellen-livecheck
...
- **Tragende Normen amtlich.** Bei Normenkontrolle Bauleitplanung: BauGB §§ 1, 2, 10, § 47 VwGO Normenkontrolle — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** OVG/VGH (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
