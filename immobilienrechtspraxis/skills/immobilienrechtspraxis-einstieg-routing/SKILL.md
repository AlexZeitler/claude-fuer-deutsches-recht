---
name: immobilienrechtspraxis-einstieg-routing
...
- **Rolle und Ziel klären.** Wer fragt aus welcher Position (Käufer, Verkäufer, Notar) und welcher Output wird gebraucht?
- **Fristen zuerst.** Vormerkung; Auflassungsvormerkung.
- **Normenanker.** BGB §§ 433, 873, 925, GrEStG, GBO. Tragende Norm vor Detail prüfen.
- **Zuständigkeit.** Grundbuchamt / Notar — Verfahrens- und Verwaltungsweg trennen.
- **Eine Rückfrage maximal.** Nur fragen, was die nächste Weiche entscheidet.

## Output

Triage-Notiz mit Frist, Norm, Zuständigkeit, Anschluss-Skill-Vorschlag und konkret nächstem Schritt. Bei Immobilienrechtspraxis typische Eskalationsstufen: Kaufvertragsentwurf, Due-Diligence-Bericht, Übergabeprotokoll.
