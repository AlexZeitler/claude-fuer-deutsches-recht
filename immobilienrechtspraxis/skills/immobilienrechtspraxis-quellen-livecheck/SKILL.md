...
- **Tragende Normen amtlich.** Bei Immobilienrechtspraxis: BGB §§ 433, 873, 925, GrEStG, GBO — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** Grundbuchamt (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
