---
name: umweltrecht-quellen-livecheck
...
- **Tragende Normen amtlich.** Bei Umweltrecht: BImSchG, BNatSchG, WHG, BBodSchG, UVPG — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** Umweltbehörden Länder (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
