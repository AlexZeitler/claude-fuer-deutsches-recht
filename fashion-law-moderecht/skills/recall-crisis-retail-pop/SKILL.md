...
description: "Recall Crisis Fashion, Retail Pop Up Store: Recall Crisis Fashion; Retail Pop Up Store. Führt Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck zusammen."
---
...
## 1. `recall-crisis-fashion`

**Fokus:** Rückruf- und Krisenmanagement für Fashion-Produkte: GPSR, Behörden, Händler, Kundenkommunikation, Presse, Plattformen und Lessons Learned.
...
## 2. `retail-pop-up-store`

**Fokus:** Retail, Pop-up-Store und Shop-in-Shop rechtlich organisieren: Mietfläche, Genehmigungen, Personal, Musik, Kasse, Versicherung und Markenauftritt.
