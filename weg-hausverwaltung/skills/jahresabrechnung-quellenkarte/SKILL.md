...
description: "Nutze dies, wenn Jahresabrechnung Quellenkarte im Plugin Weg Hausverwaltung konkret bearbeitet werden soll. Auslöser: Welche amtliche Quelle prüfe ich zuerst?; Gibt es aktuelle Rechtsprechung?; Bitte Fundstellen verifizieren.."
---
...
Nutze diese Quellenkarte, wenn im Bereich **Weg Hausverwaltung** tragende Normen, Rechtsprechung, Behördenpraxis, Register, Formulare oder aktuelle Leitlinien geprüft werden müssen.

## Suchraster

- `abrechnung-ist-plan-mieterschnittstelle`
- `anwalt-amtsgericht-gewerbe-restaurant-grossakte`
- `bad-umbau-barrierefreie-einladung-bauliche-veraenderung`
- `bad-umbau-bodengleiche-dusche-sondereigentum-gemeinschaft`
- `barrierefreie-einladung-protokoll-versammlung`
