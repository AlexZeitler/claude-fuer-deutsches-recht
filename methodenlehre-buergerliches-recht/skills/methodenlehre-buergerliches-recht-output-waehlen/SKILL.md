---
name: methodenlehre-buergerliches-recht-output-waehlen
...
Nutze diesen Skill, wenn im Bereich **Methodenlehre Buergerliches Recht** ein Fall noch sortiert, Dokumente eingeordnet, Quellen geprüft oder der nächste Arbeitsweg gewählt werden muss. Der Skill soll nicht allgemein reden, sondern schnell in den passenden Fachpfad führen.
...
- `abwaegungszustaendigkeit-institutionen-buergerlichen-verjaehrung` — Abwaegungszustaendigkeit Institutionen Buergerlichen Verjaehrung
...
- `begruendung-anhoerung-und-adressatenfaehigkeit` — Begruendung Anhoerung Und Adressatenfaehigkeit
...
- **Zweck zuerst.** Bei Methodenlehre Bürgerliches Recht typische Outputs: Auslegungs-Analyse (vier Methoden), Subsumtion, Streitstandsdarstellung.
- **Adressat bestimmt Ton.** Mandant (klar, Sie-Form) / Gegner (Anwalt, sachlich) / Behörde/Gericht (zuständiges Gericht, formal, mit Norm- und Az-Angabe).
...
Format-Wahl mit kurzer Begründung, einer Alternative und fertigem Bausteinen; bei Methodenlehre Bürgerliches Recht sofort: Auslegungs-Analyse (vier Methoden) oder Subsumtion.
