...
- **Problemfokus dieses Skills:** Bleibe beim konkreten Titel `Workflow-Router: Anschluss-Skills intelligent auswählen` und löse die dort angelegte Fachfrage; keine Flucht in allgemeines Routing, außer eine echte Frist oder Zuständigkeit ist unklar.
