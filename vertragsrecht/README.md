...
| Skill | Beschreibung |
| --- | --- |
| `aenderungs-historie-agb-eskalations-marker` | Nutze dies, wenn Aenderungs Historie, Agb Prüfung, Eskalations Marker im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Bitte Aenderungs Historie, Agb Prüfung, Eskalations Marker prüfen.; Erstelle eine Arbeitsfassung zu A... |
| `anschluss-router` | Nutze dies, wenn Allgemein, Workflow Anschluss Skills Router, Workflow Chronologie Und Belegmatrix im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Bitte Allgemein, Workflow Anschluss Skills Router, Workflow Chronologie... |
| `bgb-business-einzelabrufe-sonderfall` | Nutze dies, wenn Spezial Bgb Dokumentenmatrix Und Lueckenliste, Spezial Business Compliance Dokumentation Und Akte, Spezial Einzelabrufe Sonderfall Und Edge Case im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Bitte Spe... |
| `dokumente-intake` | Nutze dies, wenn Dokumentenintake im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Ich lade Unterlagen hoch.; Was fehlt noch?; Bitte Dokumente sortieren.. |
| `einstieg-routing` | Nutze dies, wenn Einstieg und Routing im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Ich habe ein neues Thema im Bereich Vertragsrecht.; Welche Unterlagen brauchen Sie?; Welcher Spezialskill passt?. |
| `eskalations-quellenkarte` | Nutze dies, wenn Eskalations Quellenkarte im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Welche amtliche Quelle prüfe ich zuerst?; Gibt es aktuelle Rechtsprechung?; Bitte Fundstellen verifizieren.. |
| `fernabsatz-lieferanten-red-team` | Nutze dies, wenn Spezial Fernabsatz Formular Portal Und Einreichung, Spezial Lieferanten Tatbestand Beweis Und Belege, Spezial Prüfung Red Team Und Qualitaetskontrolle im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Was... |
| `fristen-risikoampel-mandantenkommunikation` | Nutze dies, wenn Workflow Fristen Und Risikoampel, Workflow Mandantenkommunikation, Workflow Redteam Qualitygate im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Was kann hier schiefgehen?; Bitte red-team prüfen.; Welche... |
| `fristennotiz-naechster-vertriebsvertraege` | Nutze dies, wenn Spezial Anpassen Fristennotiz Und Naechster Schritt, Spezial Vertriebsvertraege Fristen Form Und Zustaendigkeit, Lieferantenvertrag Prüfung im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Bitte Spezial... |
| `mandat-arbeitsbereich-vr-einfuehrung` | Nutze dies, wenn Vertragsrecht Mandat Arbeitsbereich, Vr Einfuehrung Vertragstypen Bgb, Abmahnung Uwg im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Bitte Vertragsrecht Mandat Arbeitsbereich, Vr Einfuehrung Vertragstyp... |
...
| `nda-pruefungsvorschlaege-saas-msa` | Nutze dies, wenn Nda Prüfung, Pruefungsvorschlaege, Saas Msa Prüfung im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Bitte Nda Prüfung, Pruefungsvorschlaege, Saas Msa Prüfung prüfen.; Erstelle eine Arbeitsfassung zu Nda... |
| `output-waehlen` | Nutze dies, wenn Output wählen im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Bitte Output wählen prüfen.; Erstelle eine Arbeitsfassung zu Output wählen.; Welche Normen und Nachweise brauche ich?. |
| `quellen-livecheck` | Nutze dies, wenn Rechtsquellen-Livecheck im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Welche amtliche Quelle prüfe ich zuerst?; Gibt es aktuelle Rechtsprechung?; Bitte Fundstellen verifizieren.. |
| `rahmenvertrag-beweislast-vertragsrecht-vert` | Nutze dies, wenn Spezial Rahmenvertrag Beweislast Und Darlegungslast, Spezial Vertragsrecht Erstpruefung Und Mandatsziel, Vert Rahmenvertrag Einzelabrufe Spezial im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Bitte Spe... |
| `rechtsquellen` | Nutze dies, wenn Rechtsquellen: Abschlussprodukt und Übergabe im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Welche amtliche Quelle prüfe ich zuerst?; Gibt es aktuelle Rechtsprechung?; Bitte Fundstellen verifizieren.. |
| `renewal-review-routing` | Nutze dies, wenn Spezial Renewal Schriftsatz Brief Und Memo Bausteine, Spezial Review Behörden Gericht Und Registerweg, Spezial Routing Zahlen Schwellen Und Berechnung im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Ich... |
| `saas-tracking-vert` | Nutze dies, wenn Spezial Saas Risikoampel Und Gegenargumente, Spezial Tracking Verhandlung Vergleich Und Eskalation, Spezial Vert Mandantenkommunikation Entscheidungsvorlage im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöse... |
| `unterlagen-luecken` | Nutze dies, wenn Unterlagen und Lücken im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Ich lade Unterlagen hoch.; Was fehlt noch?; Bitte Dokumente sortieren.. |
| `vert-agb-vert-leistungsstoerungen-vr-agb` | Nutze dies, wenn Vert Agb Kontrolle B2B Spezial, Vert Leistungsstoerungen Leitfaden, Vr Agb Recht Grundzuege im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Bitte Vert Agb Kontrolle B2B Spezial, Vert Leistungsstoerungen... |
| `vert-vertragsschluss-vertragspruefung` | Nutze dies, wenn Vert Vertragsschluss Bauleiter, Vertragspruefung, Vertragsrecht Anpassen im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Bitte Vert Vertragsschluss Bauleiter, Vertragspruefung, Vertragsrecht Anpassen pr... |
...
| `vr-leistungsstoerungen-widerruf-fernabsatz` | Nutze dies, wenn Vr Leistungsstoerungen Spezial, Widerruf Fernabsatz im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Bitte Vr Leistungsstoerungen Spezial, Widerruf Fernabsatz prüfen.; Erstelle eine Arbeitsfassung zu Vr... |
| `widerruf-zusammenfassungen-interessen` | Nutze dies, wenn Spezial Widerruf Internationaler Bezug Und Schnittstellen, Spezial Zusammenfassungen Mehrparteien Konflikt Und Interessen, Stakeholder Zusammenfassung im Plugin Vertragsrecht konkret bearbeitet werden soll. Auslöser: Bit... |
