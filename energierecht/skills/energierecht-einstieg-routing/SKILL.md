---
name: energierecht-einstieg-routing
...
- **Rolle und Ziel klären.** Wer fragt aus welcher Position (Erzeuger, Netzbetreiber, BNetzA) und welcher Output wird gebraucht?
- **Fristen zuerst.** Beschwerde BNetzA-Beschluss 1 Monat § 75 EnWG; Netzanschlussfristen.
- **Normenanker.** EnWG, EEG, KWKG. Tragende Norm vor Detail prüfen.
- **Zuständigkeit.** BNetzA / Landesregulierungsbehörden — Verfahrens- und Verwaltungsweg trennen.
- **Eine Rückfrage maximal.** Nur fragen, was die nächste Weiche entscheidet.

## Output

Triage-Notiz mit Frist, Norm, Zuständigkeit, Anschluss-Skill-Vorschlag und konkret nächstem Schritt. Bei Energierecht (EnWG, EEG) typische Eskalationsstufen: EnWG-Stellungnahme, Beschwerde BNetzA, Vergütungsantrag.
