---
name: kompendium-19-verhandlung-term-she-bis-zag-finanztransferge
description: "factoring-recht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Verhandlung Term Sheet Factoringlinie, Zag Finanztransfergeschaeft Schnittstelle Factoring; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck."
---

# Arbeitsbereich - Verhandlung Term Sheet Factoringlinie, Zag Finanztransfergeschaeft Schnittstelle Factoring
...
- **Spezialgegenstand:** Verhandlung Term Sheet Factoringlinie; dieser Skill beginnt mit der Sachfrage und liefert eine konkrete Lösung statt bloßer Orientierung.
...
- **Spezialgegenstand:** ZAG Finanztransfergeschäft Schnittstelle Factoring; dieser Skill beginnt mit der Sachfrage und liefert eine konkrete Lösung statt bloßer Orientierung.
- **Normen-/Quellenanker:** BGB Forderungsabtretung, HGB, KWG/ZAG-Erlaubnisfragen, InsO-Anfechtung, Factoringvertrag, Debitorenmanagement, Datenschutz und Geldwäsche.
- **Entscheidende Weiche:** Echtes/unechtes Factoring, Forderungsbestand, Abtretbarkeit, Einwendungen, Debitoreninformation, Insolvenzrisiko und Refinanzierung trennen.
- **Arbeitsprodukt:** Erzeuge eine konkrete Prüf- oder Entscheidungsmatrix mit Norm, Tatbestand, Beleg, Einwand, Risikoampel und nächstem Schritt; Anschluss-Skills nur bei echter Vertiefung nennen.
