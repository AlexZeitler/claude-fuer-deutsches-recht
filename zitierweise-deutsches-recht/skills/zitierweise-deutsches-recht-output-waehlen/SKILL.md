---
name: zitierweise-deutsches-recht-output-waehlen
...
- **Zweck zuerst.** Bei Zitierweise deutsches Recht typische Outputs: Zitiernachweis, Quellenverzeichnis, Korrektur falsch zitierter Stellen.
- **Adressat bestimmt Ton.** Mandant (klar, Sie-Form) / Gegner (Korrektor, sachlich) / Behörde/Gericht (zuständiges Gericht, formal, mit Norm- und Az-Angabe).
...
Format-Wahl mit kurzer Begründung, einer Alternative und fertigem Bausteinen; bei Zitierweise deutsches Recht sofort: Zitiernachweis oder Quellenverzeichnis.
