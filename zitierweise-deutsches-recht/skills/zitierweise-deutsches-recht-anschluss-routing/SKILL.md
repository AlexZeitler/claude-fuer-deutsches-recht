---
name: zitierweise-deutsches-recht-anschluss-routing
...
- **Engpass zuerst.** Bei Zitierweise deutsches Recht typischer Engpass: erste Frist oder Entscheidung.
- **Skill-Auswahl** nach Sachverhalt, Rolle (Autor, Korrektor), Frist und gewünschtem Output.
