---
name: einfache-leichte-sprache-jura-quellen-livecheck
...
- **Tragende Normen amtlich.** Bei Einfache/Leichte Sprache Jura: BGG § 11 Leichte Sprache, UN-BRK Art. 9, 21, BFSG — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** Behörden mit Verständlichkeitspflicht (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
