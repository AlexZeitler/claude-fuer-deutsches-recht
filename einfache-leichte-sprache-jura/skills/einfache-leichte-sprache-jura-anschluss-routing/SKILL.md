...
- **Engpass zuerst.** Bei Einfache/Leichte Sprache Jura typischer Engpass: erste Frist oder Originalbescheid.
- **Skill-Auswahl** nach Sachverhalt, Rolle (Adressat mit Lese-/Lernbeeinträchtigung, Anwalt/Behörde), Frist und gewünschtem Output.
