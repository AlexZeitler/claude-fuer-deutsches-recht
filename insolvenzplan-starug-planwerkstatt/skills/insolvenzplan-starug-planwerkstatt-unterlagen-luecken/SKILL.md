---
name: insolvenzplan-starug-planwerkstatt-unterlagen-luecken
...
- **Fehlende Tatsache vs. fehlender Beleg.** Bei Insolvenzplan / StaRUG oft fehlend: Insolvenzplan, Restrukturierungsplan, Gruppenbildung.
- **Pro Lücke.** Beweisthema, Beweismittel (Liquiditätsplan, Sanierungskonzept), Beschaffungsweg, Ersatznachweis.
- **Prioritätsregel.** Frist > Beweislast > materielle Voraussetzung > Taktik; konkret: Erörterungstermin.
...
Priorisierte Lückenliste mit Frist, Beweiszweck, Beschaffungsweg, Ersatznachweis und Verantwortlichem; im Mandat Insolvenzplan / StaRUG typischerweise Insolvenzplan, Restrukturierungsplan zuerst.
