...
description: "Darstellender: Livequellen- und Rechtsprechungscheck im Insolvenzplan und StaRUG: fachlich vertiefter Spezialskill mit Normenradar (InsO/StaRUG/Planrecht), Tatbestands-/Beweislastmatrix, Fristen- und Formcheck, Gegenargumenten, Fehlerbremse und direkt nutzbarem Arbeitsprodukt."
---

# Darstellender: Livequellen- und Rechtsprechungscheck

## Fachlicher Kern — Insolvenz- und Sanierungsrecht
- **Problemfokus dieses Skills:** Bleibe beim konkreten Titel `Darstellender: Livequellen- und Rechtsprechungscheck` und löse die dort angelegte Fachfrage; keine Flucht in allgemeines Routing, außer eine echte Frist oder Zuständigkeit ist unklar.
...
## Spezialwissen: Darstellender: Livequellen- und Rechtsprechungscheck
- **Spezialgegenstand:** Darstellender: Livequellen- und Rechtsprechungscheck / spezial darstellender livequellen und rechtsprechungscheck. Der Skill löst diese konkrete Lage und darf nicht in allgemeines Routing ausweichen.
