...
- **Engpass zuerst.** Bei Fachanwalt Internationales Wirtschaftsrecht typischer Engpass: Schiedsklage-Fristen je Regelwerk oder Internationaler Vertrag.
- **Skill-Auswahl** nach Sachverhalt, Rolle (Internationale Vertragspartner, Schiedsrichter), Frist und gewünschtem Output.
