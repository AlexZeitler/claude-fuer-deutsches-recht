...
description: "Famfg: Livequellen- und Rechtsprechungscheck im Familienrecht: fachlich vertiefter Spezialskill mit Normenradar (BGB/FamFG/VersAusglG), Tatbestands-/Beweislastmatrix, Fristen- und Formcheck, Gegenargumenten, Fehlerbremse und direkt nutzbarem Arbeitsprodukt."
---

# Famfg: Livequellen- und Rechtsprechungscheck

## Fachlicher Kern — Familienrecht
- **Problemfokus dieses Skills:** Bleibe beim konkreten Titel `Famfg: Livequellen- und Rechtsprechungscheck` und löse die dort angelegte Fachfrage; keine Flucht in allgemeines Routing, außer eine echte Frist oder Zuständigkeit ist unklar.
...
## Spezialwissen: Famfg: Livequellen- und Rechtsprechungscheck
- **Spezialgegenstand:** Famfg: Livequellen- und Rechtsprechungscheck / spezial famfg livequellen und rechtsprechungscheck. Der Skill löst diese konkrete Lage und darf nicht in allgemeines Routing ausweichen.
