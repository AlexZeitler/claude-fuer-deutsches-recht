...
description: "Output wählen im Plugin fachanwalt-familienrecht: entscheidet zwischen Memo, Schriftsatz, Tabelle, Brief, Checkliste, Vermerk, Redline oder Mandantenübersetzung."
---
...
## Aufgabe
Dieser Workflow-Skill für `fachanwalt-familienrecht` Output wählen im Plugin fachanwalt-familienrecht: entscheidet zwischen Memo, Schriftsatz, Tabelle, Brief, Checkliste, Vermerk, Redline oder Mandantenübersetzung.. Er ist dazu da, den Nutzer schneller und sicherer in die richtige Bearbeitung zu führen.
