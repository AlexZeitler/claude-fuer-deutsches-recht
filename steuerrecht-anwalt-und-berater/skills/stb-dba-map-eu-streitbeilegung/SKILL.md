---
name: stb-dba-map-eu-streitbeilegung
...
- **Problemfokus dieses Skills:** Bleibe beim konkreten Titel `DBA: MAP und EU-Streitbeilegung` und löse die dort angelegte Fachfrage; keine Flucht in allgemeines Routing, außer eine echte Frist oder Zuständigkeit ist unklar.
...
- **Belege im Original und Beglaubigung**: Steuerbescheide aller Staaten, Zahlungen, Vertraege, Transfer-Pricing-Dokumentation, Reisekalender (bei Lohnsteuer-MAP), CRM-Auszug (bei Vertreter-BS-MAP).
...
8. **Anlagen**: Bescheide aller Staaten, Zahlungen, Vertraege, TP-Doku, Reisekalender, Substanz-Doku.

## Berechnungsbeispiel: VP-Doppelbesteuerung

Sachverhalt: DE-Tochter (BG: 100k EUR Gewinn) bezieht Management-Fee 200k EUR von US-Mutter. US-Pruefer korrigiert auf 300k EUR (Art. 9 Abs. 1 US-DBA — fremduebliche Verrechnung), DE-Pruefer korrigiert nicht.
...
|---|---|---|
| MAP Art. 25 MA | nach Doppelbesteuerung erkannt | bilateral, ohne Schiedszwang (ausser MLI Art. 19 — pruefen) |
...
| Klage FG | innerhalb 1 Monat nach Einspruchsbescheid | parallel MAP moeglich |
...
| Vertraege (Arbeitsvertrag, Lizenzvertrag, VP-Vertrag) | wirtschaftliche Grundlage |
