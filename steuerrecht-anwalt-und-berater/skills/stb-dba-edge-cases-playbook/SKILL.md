---
name: stb-dba-edge-cases-playbook
...
- **Problemfokus dieses Skills:** Bleibe beim konkreten Titel `DBA-Edge-Case-Playbook` und löse die dort angelegte Fachfrage; keine Flucht in allgemeines Routing, außer eine echte Frist oder Zuständigkeit ist unklar.
