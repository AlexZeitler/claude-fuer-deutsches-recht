---
name: verkehr-infrastrukturrecht-quellen-livecheck
...
- **Tragende Normen amtlich.** Bei Verkehr-Infrastrukturrecht: FStrG, AEG, PBefG, BFStrG, VwVfG — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** Eisenbahn-BBundesamt (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
