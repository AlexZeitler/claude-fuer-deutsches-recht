...
- **Rolle und Ziel klären.** Wer fragt aus welcher Position (Verlag, Autor, Redakteur) und welcher Output wird gebraucht?
- **Fristen zuerst.** Gegendarstellungsanspruch unverzüglich.
- **Normenanker.** UrhG, VerlagsG, Presserechte Länder. Tragende Norm vor Detail prüfen.
- **Zuständigkeit.** Presserat / Datenschutzaufsicht — Verfahrens- und Verwaltungsweg trennen.
- **Eine Rückfrage maximal.** Nur fragen, was die nächste Weiche entscheidet.

## Output

Triage-Notiz mit Frist, Norm, Zuständigkeit, Anschluss-Skill-Vorschlag und konkret nächstem Schritt. Bei Verlagsredaktion typische Eskalationsstufen: Verlagsvertrag, Pressemitteilung, Gegendarstellung.
