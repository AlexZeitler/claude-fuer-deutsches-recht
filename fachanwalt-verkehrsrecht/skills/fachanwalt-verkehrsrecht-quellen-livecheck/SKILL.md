...
- **Tragende Normen amtlich.** Bei Fachanwalt Verkehrsrecht: StGB §§ 142, 315c, 316, StVG, StVO — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** AG (Bußgeld + Straf) (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
