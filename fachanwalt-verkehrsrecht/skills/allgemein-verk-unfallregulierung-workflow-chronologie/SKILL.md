---
name: allgemein-verk-unfallregulierung-workflow-chronologie
description: "Allgemein, Verk Unfallregulierung Workflow, Workflow Chronologie Und Belegmatrix: Allgemein; Verk Unfallregulierung Workflow; Workflow Chronologie Und Belegmatrix. Führt Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck zusammen."
---

# Allgemein, Verk Unfallregulierung Workflow, Workflow Chronologie Und Belegmatrix
...
| `verk-unfallregulierung-workflow` | Workflow Unfallregulierung: Anspruchsgrundlagen § 7 StVG / § 18 StVG / § 823 BGB / § 115 VVG, Quote, Schadenspositionen Wiederbeschaffungswert, Wertminderung, Nutzungsausfall. Pruefraster fuer Geschaedigtenanwalt. |
...
**Fokus:** Workflow Unfallregulierung: Anspruchsgrundlagen § 7 StVG / § 18 StVG / § 823 BGB / § 115 VVG, Quote, Schadenspositionen Wiederbeschaffungswert, Wertminderung, Nutzungsausfall. Pruefraster fuer Geschaedigtenanwalt.

# Verk: Unfallregulierung-Workflow

## Spezialwissen: Verk: Unfallregulierung-Workflow
- **Spezialgegenstand:** Verk: Unfallregulierung-Workflow / verk unfallregulierung workflow. Der Skill löst diese konkrete Lage und darf nicht in allgemeines Routing ausweichen.
...
## Plugin-Kontext
Dieser Skill gehoert zum Plugin `fachanwalt-verkehrsrecht`. Er ergaenzt die uebrigen Skills des Plugins um einen vertieften Spezialfall oder eine systematische Einfuehrung. Bei Folgefragen werden andere Skills des Plugins als Anschluss vorgeschlagen.
...
## Aufgabe
Dieser Workflow-Skill für `fachanwalt-verkehrsrecht` Chronologie und Belegmatrix im Plugin fachanwalt-verkehrsrecht: macht aus unordentlichem Material eine Timeline mit Belegstellen und offenen Widersprüchen.. Er ist dazu da, den Nutzer schneller und sicherer in die richtige Bearbeitung zu führen.
