...
description: "Nutze dies, wenn Screenreader Quellenkarte im Plugin Barrierefreiheit Web Checker konkret bearbeitet werden soll. Auslöser: Welche amtliche Quelle prüfe ich zuerst?; Gibt es aktuelle Rechtsprechung?; Bitte Fundstellen verifizieren.."
---
...
- `bf-kiosk-bf-mediendienste-bf-pdf`
- `bfsg-zeitleiste-ecommerce-checkout-en301549-wcag`
...
- `pdf-downloads-remediation-roadmap-schulung-rolle`
- `pdf-formulare-automatisierter-audit-bf-kanzleiwebsite`
