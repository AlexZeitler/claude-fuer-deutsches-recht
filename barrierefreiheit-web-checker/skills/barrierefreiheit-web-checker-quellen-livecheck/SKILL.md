---
name: barrierefreiheit-web-checker-quellen-livecheck
...
- **Tragende Normen amtlich.** Bei Barrierefreiheit Web BFSG/WCAG: BFSG, BFSG-Verordnung, WCAG 2.1 AA — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** BFA (Bundesfachstelle Barrierefreiheit) (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
