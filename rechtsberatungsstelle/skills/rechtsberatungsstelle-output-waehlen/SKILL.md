...
- **Zweck zuerst.** Bei Rechtsberatungsstelle (RDG) typische Outputs: Erstberatungsmemo, Beratungshilfeantrag, Weiterleitung Anwalt.
- **Adressat bestimmt Ton.** Mandant (klar, Sie-Form) / Gegner (Berater, sachlich) / Behörde/Gericht (Amtsgericht, formal, mit Norm- und Az-Angabe).
- **Frist und Form** der Außenkommunikation beachten: Beratungshilfe-Antrag vor Tätigkeit.
...
Format-Wahl mit kurzer Begründung, einer Alternative und fertigem Bausteinen; bei Rechtsberatungsstelle (RDG) sofort: Erstberatungsmemo oder Beratungshilfeantrag.
