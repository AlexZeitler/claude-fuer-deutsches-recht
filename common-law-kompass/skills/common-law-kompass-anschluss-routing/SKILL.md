...
- **Engpass zuerst.** Bei Common Law Kompass typischer Engpass: Statutes of Limitations je Jurisdiction oder Pleadings.
- **Skill-Auswahl** nach Sachverhalt, Rolle (Mandant US/UK, Counsel local), Frist und gewünschtem Output.
