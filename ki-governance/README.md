...
| Skill | Beschreibung |
| --- | --- |
| `case-dpia-drift` | Nutze dies bei Case Tatbestand Beweis Und Belege, Dpia Risikoampel Und Gegenargumente, Drift Verhandlung Vergleich Und Eskalation: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belas... |
| `dsgvo-governance-inventar` | Nutze dies bei Dsgvo Erstpruefung Und Mandatsziel, Governance Compliance Dokumentation Und Akte, Inventar Dokumentenmatrix Und Lueckenliste: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den näch... |
| `gpai-modelle-ki-anbieter-arbeitsrecht` | Nutze dies bei Gpai Modelle Systemic Risk, Ki Anbieter Prüfung, Ki Arbeitsrecht Mitbestimmung: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `inventar-kontrollen-konformitaetsbewertung` | Nutze dies bei Ki Inventar Governance Und Kontrollen, Konformitaetsbewertung Red Team Und Qualitaetskontrolle, Marketing Mandantenkommunikation Entscheidungsvorlage: führt durch diese fachlich verbundenen Module, wählt den passenden Prüf... |
| `ki-folgenabschaetzung-ki-governance-mandat` | Nutze dies bei Ki Folgenabschaetzung, Ki Governance Anpassen, Ki Governance Mandat Arbeitsbereich: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `ki-governance-anschluss-router` | Nutze dies bei Allgemein, Anschluss Skills Router, Chronologie Und Belegmatrix, ...: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `ki-governance-dokumente-intake` | Nutze dies für Unterlagen zu Dokumentenintake: sortiert Dokumente, erkennt Lücken, ordnet Beweiswert und formuliert gezielte Rückfragen. |
| `ki-governance-einstieg-routing` | Nutze dies zum Einstieg in Einstieg und Routing: klärt Rolle, Ziel, Frist, Aktenlage und den passenden nächsten Fachpfad. |
| `ki-governance-fristen-risikoampel-mandantenkommunikation` | Nutze dies bei Fristen Und Risikoampel, Mandantenkommunikation, Redteam Qualitygate: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
...
| `ki-governance-output-waehlen` | Nutze dies bei Output wählen: prüft die konkrete Fachfrage mit Normen, Belegen, Risiken, Gegenargumenten und einem verwertbaren Arbeitsergebnis. |
| `ki-governance-quellen-livecheck` | Nutze dies zur Quellenprüfung bei Rechtsquellen-Livecheck: Normenstand, Rechtsprechung, Behördenpraxis und Zitierfähigkeit werden vor einer tragenden Aussage verifiziert. |
| `ki-governance-rechtsquellen-sonderfall-edge-case` | Nutze dies zur Quellenprüfung bei Rechtsquellen: Sonderfall und Edge-Case-Prüfung: Normenstand, Rechtsprechung, Behördenpraxis und Zitierfähigkeit werden vor einer tragenden Aussage verifiziert. |
| `ki-governance-unterlagen-luecken` | Nutze dies für Unterlagen zu Unterlagen und Lücken: sortiert Dokumente, erkennt Lücken, ordnet Beweiswert und formuliert gezielte Rückfragen. |
| `ki-inventar-marketing-werbung-rote-linien` | Nutze dies bei Ki Inventar, Ki Marketing Und Werbung, Ki Rote Linien Art 5 Prüfen: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `kig-konformitaetsbewertung-risikobewertung` | Nutze dies bei Kig Konformitaetsbewertung Spezial, Kig Risikobewertung Hochrisiko Leitfaden, Regulierungs Luecken Analyse: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren A... |
| `monitoring-quellenkarte` | Nutze dies zur Quellenprüfung bei Monitoring Quellenkarte: Normenstand, Rechtsprechung, Behördenpraxis und Zitierfähigkeit werden vor einer tragenden Aussage verifiziert. |
| `review-richtlinie` | Nutze dies bei Prüfung Internationaler Bezug Und Schnittstellen, Review Schriftsatz Brief Und Memo Bausteine, Richtlinie Zahlen Schwellen Und Berechnung: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und lie... |
| `richtlinien-monitor-vorlage-anbieter` | Nutze dies bei Richtlinien Monitor, Richtlinien Vorlage, Anbieter Mehrparteien Konflikt Und Interessen: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `rollen-rasci-hochrisiko-anhang-incident` | Nutze dies bei Ki Governance Rollen Rasci, Ki Hochrisiko Anhang Iii Prüfen, Ki Incident Management Art 73: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `rollenmodell-use-case-vendor` | Nutze dies bei Rollenmodell Formular Portal Und Einreichung, Use Case Risk Classification, Vendor Behörden Gericht Und Registerweg: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten bela... |
| `triage-haftung-versicherung-anwendungsfall` | Nutze dies bei Triage Fristen Form Und Zustaendigkeit, Ki Haftung Und Versicherung, Anwendungsfall Triage: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `vo-pflichtenpyramide-kig-ai-kig-foundation` | Nutze dies bei Ki Vo Pflichtenpyramide Einfuehrung, Kig Ai Act Rollenmodell Bauleiter, Kig Foundation Model Anbieterpflichten Spezial: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten b... |
| `werbung-beweislast` | Nutze dies bei Werbung Beweislast Und Darlegungslast: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
