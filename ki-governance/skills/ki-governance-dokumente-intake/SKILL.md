---
name: ki-governance-dokumente-intake
...
- **Sortieren nach Dokumenttyp.** Bei KI-Governance typisch: Risikobewertung, Konformitätserklärung, Technische Dokumentation.
- **Datum, Absender, Empfänger, Aktenzeichen** je Dokument; Fristwirkung markieren (KI-VO-Geltung gestaffelt 2025-2027, Hochrisiko-CE-Konformität).
- **Beweiswert einordnen.** Logs, Bias-Tests, Audit-Berichte jeweils mit Tatsachenbezug.
