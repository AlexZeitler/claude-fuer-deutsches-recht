...
| Skill | Beschreibung |
| --- | --- |
| `aktenbestand-pflege-bea-versand` | Nutze dies bei Aktenbestand Pflege, Bea Versand Prüfen: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `buchhaltung-konten-kanzlei-erechnung` | Nutze dies bei Kanzlei Allgemein Buchhaltung Konten, Kanzlei Allgemein Erechnung: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `freundlicher-copilot-kanzlei` | Nutze dies bei Kanzlei Allgemein Freundlicher Copilot, Kanzlei Allgemein Handelsregisterabruf: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `geburtstage-feiertage-abwesenheiten-urlaub` | Nutze dies bei Geburtstage Feiertage, Kanzlei Allgemein Abwesenheiten Urlaub: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `hr-personal-kanzlei-intake` | Nutze dies bei Kanzlei Allgemein Hr Personal, Kanzlei Allgemein Intake: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `integrationen-simulation-kanzlei` | Nutze dies bei Kanzlei Allgemein Integrationen Simulation, Kanzlei Allgemein Kanzleikalender: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `kanzlei-allgemein-allgemein` | Einstieg, Schnelltriage und Fallrouting im Kanzlei Allgemein-Plugin. Fragt Rolle, Ziel, Fristen, Unterlagen, Risiken und Wunsch-Output ab, schlägt passende Fachmodule aus diesem Plugin vor und führt in einen klaren Arbeitsplan. Bei Dokum... |
| `kanzlei-allgemein-einstieg-routing` | Nutze dies zum Einstieg in Einstieg und Routing: klärt Rolle, Ziel, Frist, Aktenlage und den passenden nächsten Fachpfad. |
...
| `kanzlei-automationen-bea-journal` | Nutze dies bei Kanzlei Allgemein Automationen, Kanzlei Allgemein Bea Journal: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
...
| `kanzlei-kanzlei-aktenzeichen` | Nutze dies bei Kanzlei Allgemein Akte, Kanzlei Allgemein Aktenzeichen: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `kanzlei-mandatsvereinbarung-kanzlei-postlauf` | Nutze dies bei Kanzlei Allgemein Mandatsvereinbarung, Kanzlei Allgemein Postlauf: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `kanzlei-monitor-kanzlei-vertragsentwurf` | Nutze dies bei Kanzlei Allgemein Fristen Monitor, Kanzlei Allgemein Vertragsentwurf: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `kanzlei-rechtsprechungsrecherche-fristenbuch` | Nutze dies bei Kanzlei Allgemein Rechtsprechungsrecherche, Fristenbuch Fuehren: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `kanzlei-turbo-kanzlei-zeitnarrative` | Nutze dies bei Kanzlei Allgemein Schriftsatz Turbo, Kanzlei Allgemein Zeitnarrative: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `kanzleitag-simulation-kanzlei` | Nutze dies bei Kanzlei Allgemein Kanzleitag Simulation, Kanzlei Allgemein Kommandocenter, Neue Sache, Mach Klage: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitssch... |
| `ki-arbeitsauftrag-mahnwesen-honorar` | Nutze dies bei Ki Arbeitsauftrag Briefing, Mahnwesen Honorar: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `lohn-sv-kanzlei-rechnung` | Nutze dies bei Kanzlei Allgemein Lohn Sv, Kanzlei Allgemein Rechnung: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `look-feel-mandatsannahme-gwg` | Nutze dies bei Kanzlei Allgemein Look And Feel, Kanzlei Allgemein Mandatsannahme Gwg: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `mandantenakte-anlegen-mandantenbrief-vorlagen` | Nutze dies bei Mandantenakte Anlegen, Mandantenbrief Vorlagen: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `posteingang-ausgang-sekretariats-tagesbrief` | Nutze dies bei Posteingang Ausgang, Sekretariats Tagesbrief: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `qualitaetsgate-hardening-kanzlei` | Nutze dies bei Kanzlei Allgemein Qualitaetsgate Hardening, Kanzlei Allgemein Schreibcanvas: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
...
| `timesheet-aktenzeitung-umgang-ki` | Nutze dies bei Timesheet Aktenzeitung, Umgang Mit Ki Vorwurf Bei Sachverstaendigengutachten: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `ustva-buchhaltung-ustva-simulation` | Nutze dies bei Kanzlei Allgemein Ustva Buchhaltung, Kanzlei Allgemein Ustva Simulation: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
| `versand-check-weihnachtskarten` | Nutze dies bei Versand Vor Check, Weihnachtskarten: führt durch diese fachlich verbundenen Module, wählt den passenden Prüfpfad und liefert den nächsten belastbaren Arbeitsschritt. |
