---
name: kompendium-06-workflow-versicherun-bis-beweislast-und-offen
description: "robotik-recht: eigenständiger Arbeits-Skill für sachlich zusammengehörige Arbeitsmodule zu Workflow Versicherungs Und Regressakte, Workflow Vertrags Und Lieferkettenintake, Workflow Zweckbestimmung Und Usecase, Robot As A Service Vertrag; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck."
---

# Arbeitsbereich - Workflow Versicherungs Und Regressakte bis Robot As A Service Vertrag
