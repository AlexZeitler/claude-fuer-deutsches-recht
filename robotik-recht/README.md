...
| `anschluss-routing` | Nutze dies, wenn Anschluss-Routing im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Ich habe ein neues Thema im Bereich Robotik Recht.; Welche Unterlagen brauchen Sie?; Welcher Spezialskill passt?. |
...
| `arbeitsschutz-betrsichv-autonome` | Nutze dies, wenn Arbeitsschutz Betrsichv Robotik, Autonome Lieferroboter Oeffentlicher Raum im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Arbeitsschutz Betrsichv Robotik, Autonome Lieferroboter Oeffentlicher Rau... |
...
| `arbeitswelt-cobot-beschaffung-oeffentlich` | Nutze dies, wenn Workflow Arbeitswelt Cobot Check, Workflow Beschaffung Öffentlich Privat, Workflow Betreiberpflichten Und Training, Workflow Beweismatrix Und Logauswertung, Workflow Board Und C Level Briefing und 1 weitere Themen im Plu... |
...
| `barrierefreiheit-inklusion-batterie` | Nutze dies, wenn Barrierefreiheit Und Inklusion Robotik, Batterie Ladeinfrastruktur Und Brandschutz, Bau Und Inspektionsroboter, Beschaeftigtendatenschutz Cobot im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Barr... |
...
| `betreiber-mitverschulden-betriebsanleitung` | Nutze dies, wenn Betreiber Mitverschulden Und Fehlbedienung, Betriebsanleitung Sprache Und Warnhinweise im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Betreiber Mitverschulden Und Fehlbedienung, Betriebsanleitung... |
...
| `biometrie-emotion-ce-zeichen-chirurgie-op` | Nutze dies, wenn Biometrie Emotion Und Personenerkennung, Ce Zeichen Fehlgebrauch Und Abmahnung, Chirurgie Und Op Robotik, Data Act Roboterdaten im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Biometrie Emotion Un... |
...
| `cra-produkt-lager-intralogistikflotte` | Nutze dies, wenn Cra Produkt Mit Digitalen Elementen, Lager Und Intralogistikflotte im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Cra Produkt Mit Digitalen Elementen, Lager Und Intralogistikflotte prüfen.; Erste... |
...
| `datenminimierung-edge-datensatzqualitaet-bias` | Nutze dies, wenn Datenminimierung Edge Cloud, Datensatzqualitaet Und Bias Hri im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Was kann hier schiefgehen?; Bitte red-team prüfen.; Welche Frist oder Beweislast übersehe ich?. |
...
| `datenschutz-cyber-first-year-uebergangsrecht` | Nutze dies, wenn Workflow Datenschutz Cyber Intake, Workflow First Year Associate Robotik, Workflow Fristen Und Uebergangsrecht, Workflow Haftungsampel, Workflow Ingenieur Rueckfragenliste und 1 weitere Themen im Plugin Robotik Recht kon... |
...
| `datenschutz-kameras-digitaler-zwilling-dronen` | Nutze dies, wenn Datenschutz Kameras Und Sensorik, Digitaler Zwilling Und Simulation, Dronen Und Robotik Schnittstelle, Dsfa Für Robotik im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Datenschutz Kameras Und Sens... |
...
| `datenverlust-digitaler-deliktische-haftung` | Nutze dies, wenn Datenverlust Und Digitaler Schaden, Deliktische Haftung Paragraph 823 Bgb, Haftung Arzt Klinik Hersteller, Schadensberechnung Produktionsausfall im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Dat... |
...
| `dual-use-eu-umsetzung` | Nutze dies, wenn Dual Use Und Militaerische Robotik, Eu De Umsetzung Und Rechtsstand Livecheck im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Dual Use Und Militaerische Robotik, Eu De Umsetzung Und Rechtsstand Li... |
...
| `einstieg-routing` | Nutze dies, wenn Einstieg und Routing im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Ich habe ein neues Thema im Bereich Robotik Recht.; Welche Unterlagen brauchen Sie?; Welcher Spezialskill passt?. |
...
| `eu-konformitaetserklaerung-foss-open` | Nutze dies, wenn Eu Konformitaetserklaerung Und Einbauerklaerung, Foss Und Open Source Komponenten, Foundation Model Und Gpai Im Roboter, Funkanlagen Und Konnektivitaet im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bi... |
...
| `geschaeftsgeheimnisse-logdaten-grundrechte` | Nutze dies, wenn Geschaeftsgeheimnisse Und Logdaten, Grundrechte Und Psychische Belastung im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Geschaeftsgeheimnisse Und Logdaten, Grundrechte Und Psychische Belastung pr... |
...
| `harmonisierte-normen-human-oversight` | Nutze dies, wenn Harmonisierte Normen Iso Ts 15066, Human Oversight In Physischer Robotik, Importeur Haendler Fulfilment Robotik, Ki Training Mit Roboterdaten im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Harmon... |
...
| `ki-vo-ki-vo` | Nutze dies, wenn Ki Vo Anhang Iii Robotik Usecases, Ki Vo Artikel 3 Ki System Robotik im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Ki Vo Anhang Iii Robotik Usecases, Ki Vo Artikel 3 Ki System Robotik prüfen.; E... |
| `ki-vo-ki-vo-ki-vo-ki-vo-kollaborierende` | Nutze dies, wenn Ki Vo Artikel 6 Hochrisiko Robotik, Ki Vo Deployer Pflichten Robotik, Ki Vo Provider Qms Und Risk Management, Ki Vo Verbotene Praktiken Robotik, Klinische Bewertung Robotik und 1 weitere Themen im Plugin Robotik Recht ko... |
| `ki-vo-laienmodus-robotikrecht-litigation` | Nutze dies, wenn Workflow Ki Vo Integrationscheck, Workflow Laienmodus Robotikrecht, Workflow Litigation Vorbereitung, Workflow Marktueberwachung Dialog, Workflow Mdr Und Gesundheitsrobotik und 1 weitere Themen im Plugin Robotik Recht ko... |
...
| `kommunal-behoerdenrobotik` | Nutze dies, wenn Kommunal Und Behoerdenrobotik, Konformitaetsbescheinigung Robotik Ki, Konformitaetsbewertung Modulwahl, Landwirtschaftsroboter Und Autonome Feldtechnik im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bi... |
...
| `lieferantenqualifizierung-sensor` | Nutze dies, wenn Lieferantenqualifizierung Sensor Cloud, Lieferantenregress Und Indemnity im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Lieferantenqualifizierung Sensor Cloud, Lieferantenregress Und Indemnity pr... |
...
| `logging-traceability-marktueberwachung` | Nutze dies, wenn Logging Und Traceability Robotik, Marktueberwachung Unterlagenvorlage, Maschine Oder Unvollstaendige Maschine, Maschinenverordnung Annex Iii Hochrisiko im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Ic... |
...
| `medizinprodukt-software-mitbestimmung` | Nutze dies, wenn Medizinprodukt Software Ki Roboter, Mitbestimmung Betriebsrat Robotik im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Medizinprodukt Software Ki Roboter, Mitbestimmung Betriebsrat Robotik prüfen.;... |
...
| `mobile-roboter-nis2-betreiber` | Nutze dies, wenn Mobile Roboter Amr Agv, Nis2 Betreiber Kritische Sektoren, Patientenaufklaerung Robotik, Pflege Und Assistenzroboter im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Mobile Roboter Amr Agv, Nis2 Be... |
...
| `open-source-post-market-presse` | Nutze dies, wenn Workflow Open Source Und Sbom, Workflow Post Market Monitoring, Workflow Presse Und Krisenkommunikation, Workflow Privacy By Design Sprint, Workflow Produkt Und Rollenprofil und 1 weitere Themen im Plugin Robotik Recht k... |
...
| `pilotbetrieb-beta-prodhaftg-pld` | Nutze dies, wenn Pilotbetrieb Und Beta Robotik, Prodhaftg Und Neue Pld Vergleich im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Pilotbetrieb Und Beta Robotik, Prodhaftg Und Neue Pld Vergleich prüfen.; Erstelle ei... |
...
| `produktakte-gap-produktbeobachtung-field` | Nutze dies, wenn Produktakte Gap Analyse, Produktbeobachtung Und Field Data, Produktfehler Verbrauchererwartung Robotik, Produktsicherheit Vs Betriebssicherheit im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Was kann h... |
...
| `produktsicherheitsrechtliche-werbung-02` | Nutze dies, wenn Produktsicherheitsrechtliche Werbung, Quasihersteller Private Label Robotik im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Produktsicherheitsrechtliche Werbung, Quasihersteller Private Label Robo... |
...
| `qualitaetsmanagement-robotikhersteller-02` | Nutze dies, wenn Qualitaetsmanagement Robotikhersteller, Accuracy Robustness Cybersecurity Ai, Agile Entwicklung Und Compliance Gates, Anwaltliche Quellenhygiene Robotik im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: W... |
...
| `rehabilitations-exoskelett-remote-update` | Nutze dies, wenn Rehabilitations Und Exoskelett Robotik, Remote Update Und Secure Channel, Risikobeurteilung En Iso 12100, Rollen Hersteller Anbieter Integrator im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Reha... |
...
| `risikoklassifizierung-schnelltest-rueckruf` | Nutze dies, wenn Workflow Risikoklassifizierung Schnelltest, Workflow Rueckruf Und Field Action, Workflow Sachverstaendigenbriefing, Workflow Security By Design Sprint, Workflow Unfall Incident Response und 1 weitere Themen im Plugin Rob... |
...
| `rueckrufpflicht-safety-safety-gate` | Nutze dies, wenn Rueckrufpflicht Und Safety Gate, Safety Gate Und Oeffentliche Warnung im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Rueckrufpflicht Und Safety Gate, Safety Gate Und Oeffentliche Warnung prüfen.;... |
...
| `sbom-cyber-serviceroboter-haushalt` | Nutze dies, wenn Sbom Und Cyber Dokumentation, Serviceroboter Haushalt Gpsr, Sicherheits Und Ueberwachungsroboter, Sicherheitskomponente Mit Ki im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Sbom Und Cyber Dokume... |
...
| `smart-factory-softwareupdate-als` | Nutze dies, wenn Smart Factory Und Industrie 4 0, Softwareupdate Als Produktbezogener Dienst im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Smart Factory Und Industrie 4 0, Softwareupdate Als Produktbezogener Die... |
...
| `sozialer-humanoider-spielzeug-kinderroboter` | Nutze dies, wenn Sozialer Humanoider Roboter, Spielzeug Und Kinderroboter, Strom Emv Und Niederspannung, Systemintegrator Als Hersteller im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Sozialer Humanoider Roboter,... |
...
| `technische-besichtigung-testdaten-validierung` | Nutze dies, wenn Technische Besichtigung Und Geheimnisschutz, Testdaten Und Validierung Vor Marktstart im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Technische Besichtigung Und Geheimnisschutz, Testdaten Und Val... |
...
| `transparenz-nutzerinformation-unfallanalyse` | Nutze dies, wenn Transparenz Und Nutzerinformation, Unfallanalyse Chain Of Custody, Vergaberecht Robotik Beschaffung, Vergleich Und Sanierung Nach Incident im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Transpare... |
...
| `vernunftigerweise-vorhersehbarer` | Nutze dies, wenn Vernunftigerweise Vorhersehbarer Gebrauch, Versicherungsdeckung Robotik im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Vernunftigerweise Vorhersehbarer Gebrauch, Versicherungsdeckung Robotik prüf... |
...
| `versicherungs-regressakte-vertrags` | Nutze dies, wenn Workflow Versicherungs Und Regressakte, Workflow Vertrags Und Lieferkettenintake, Workflow Zweckbestimmung Und Usecase, Robot As A Service Vertrag im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Ich lad... |
...
| `vigilanz-medizinrobotik-vulnerability` | Nutze dies, wenn Vigilanz Medizinrobotik, Vulnerability Disclosure Und Reporting, Wesentliche Veraenderung Digital, Zweckbestimmung Enge Nutzungsbedingungen im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Vigilanz... |
...
| `wartungs-servicevertrag-beweislast` | Nutze dies, wenn Wartungs Und Servicevertrag Robotik, Beweislast Und Offenlegung Produkthaftung im Plugin Robotik Recht konkret bearbeitet werden soll. Auslöser: Bitte Wartungs Und Servicevertrag Robotik, Beweislast Und Offenlegung Produ... |
