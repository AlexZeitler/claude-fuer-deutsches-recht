...
| Skill | Beschreibung |
| --- | --- |
| `kompendium-01-allgemein-bis-workflow-chronologie` | hausarbeitenmacher: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Allgemein, Hausarbeit Workflow Start, Chronologie Und Belegmatrix; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck. |
| `kompendium-02-workflow-fristen-und-bis-quellenrecherche-rec` | hausarbeitenmacher: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Fristen Und Risikoampel, Redteam Qualitygate, Quellenrecherche Rechtsprechung Literatur; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmu... |
| `kompendium-03-europarecht-anwendba-bis-bearbeitungsplan-ers` | hausarbeitenmacher: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Europarecht Anwendbarkeit Vorrang Vorabentscheidung, Hausarbeiten Fristen Form Und Zustaendigkeit, Bearbeitungsplan Erstellen; mit Intake, Prüfroutine, Norme... |
| `kompendium-04-behutsame-frech-wert-bis-selbstkontrolle-vor` | hausarbeitenmacher: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Behutsame Frech Wertschaetzende Rueckfragen, Haeufige Fehler Vermeiden, Selbstkontrolle Vor Abgabe; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogi... |
| `kompendium-05-aufgabenstellung-erf-bis-gliederung-mit-tiefe` | hausarbeitenmacher: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Aufgabenstellung Erfassen, Fachgebiet Routing Zivil Oeffentlich Straf, Gliederung Mit Tiefenstruktur; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislo... |
| `kompendium-06-gutachtenstil-vs-urt-bis-haus-literaturrecher` | hausarbeitenmacher: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Gutachtenstil Vs Urteilsstil, Haus Fussnotenstil Spezial, Haus Literaturrecherche Leitfaden; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outp... |
| `kompendium-07-haus-plagiatscheck-e-bis-meinungsstreit-darst` | hausarbeitenmacher: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Haus Plagiatscheck Eigenstaendigkeit Spezial, Haus Themaeingrenzung Bauleiter, Meinungsstreit Darstellen; mit Intake, Prüfroutine, Normen-/Quellenradar, Bewe... |
| `kompendium-08-methodenlehre-ausleg-bis-professor-erkennen-u` | hausarbeitenmacher: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Methodenlehre Auslegung, Oeffentliches Recht Statthaft Zulaessig Begruendet, Professor Erkennen Und Strategie; mit Intake, Prüfroutine, Normen-/Quellenradar,... |
| `kompendium-09-rechtstheorie-rechts-bis-spezial-adressaten-f` | hausarbeitenmacher: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Rechtstheorie Rechtsphilosophie Anbindung, Seminararbeit Modus, Adressaten Formular Portal Und Einreichung; mit Intake, Prüfroutine, Normen-/Quellenradar, Be... |
| `kompendium-10-spezial-ausfluegen-c-bis-spezial-durch-schrif` | hausarbeitenmacher: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Ausfluegen Compliance Dokumentation Und Akte, Didaktisches Erstpruefung Und Mandatsziel, Durch Schriftsatz Brief Und Memo Bausteine; mit Intake, Prüfroutine,... |
| `kompendium-11-spezial-europarecht-bis-spezial-fuehrt-risik` | hausarbeitenmacher: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Europarecht Mehrparteien Konflikt Und Interessen, Fertigen Sonderfall Und Edge Case, Fuehrt Risikoampel Und Gegenargumente; mit Intake, Prüfroutine, Normen-/... |
| `kompendium-12-spezial-juristische-bis-spezial-rechtstheori` | hausarbeitenmacher: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Juristische Tatbestand Beweis Und Belege, Liefert Beweislast Und Darlegungslast, Rechtstheorie Internationaler Bezug Und Schnittstellen; mit Intake, Prüfrout... |
| `kompendium-13-spezial-schleimerei-bis-spezial-sokratisch-b` | hausarbeitenmacher: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Schleimerei Mandantenkommunikation Entscheidungsvorlage, Seminararbeiten Dokumentenmatrix Und Lueckenliste, Sokratisch Behoerden Gericht Und Registerweg; mit... |
| `kompendium-14-spezial-strafrecht-z-bis-strafrecht-tatbestan` | hausarbeitenmacher: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Strafrecht Zahlen Schwellen Und Berechnung, Zivilrecht Verhandlung Vergleich Und Eskalation, Strafrecht Tatbestand Rechtswidrigkeit Schuld; mit Intake, Prüfr... |
| `kompendium-15-subsumtion-schritt-f-bis-zitierweise-jura-fun` | hausarbeitenmacher: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Subsumtion Schritt Fuer Schritt, Verfassungsrecht Grundrechtspruefung, Zitierweise Jura Fundstellen; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislog... |
| `kompendium-16-zivilrecht-anspruchs-bis-zivilrecht-anspruchs` | hausarbeitenmacher: eigenständiger Arbeits-Skill zu Zivilrecht Anspruchsgrundlagen Pruefung; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck. |
