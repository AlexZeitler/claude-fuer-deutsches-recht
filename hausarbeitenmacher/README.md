...
| Skill | Beschreibung |
| --- | --- |
| `allgemein-hausarbeit-start-workflow-chronologie` | Allgemein, Hausarbeit Workflow Start, Workflow Chronologie Und Belegmatrix: Allgemein; Hausarbeit Workflow Start; Workflow Chronologie Und Belegmatrix. Führt Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualit... |
| `aufgabenstellung-erfassen-fachgebiet-routing-gliederung` | Aufgabenstellung Erfassen, Fachgebiet Routing Zivil Öffentlich Straf, Gliederung Mit Tiefenstruktur: Aufgabenstellung Erfassen; Fachgebiet Routing Zivil Öffentlich Straf; Gliederung Mit Tiefenstruktur. Führt Intake, Prüfroutine, Normen-/... |
| `ausfluegen-didaktisches-durch` | Spezial Ausfluegen Compliance Dokumentation Und Akte, Spezial Didaktisches Erstpruefung Und Mandatsziel, Spezial Durch Schriftsatz Brief Und Memo Bausteine: Spezial Ausfluegen Compliance Dokumentation Und Akte; Spezial Didaktisches Erstp... |
| `behutsame-frech-haeufige-fehler-selbstkontrolle-abgabe` | Behutsame Frech Wertschaetzende Rueckfragen, Haeufige Fehler Vermeiden, Selbstkontrolle Vor Abgabe: Behutsame Frech Wertschaetzende Rueckfragen; Haeufige Fehler Vermeiden; Selbstkontrolle Vor Abgabe. Führt Intake, Prüfroutine, Normen-/Qu... |
| `europarecht-anwendbarkeit-hausarbeiten-bearbeitungsplan` | Europarecht Anwendbarkeit Vorrang Vorabentscheidung, Spezial Hausarbeiten Fristen Form Und Zustaendigkeit, Bearbeitungsplan Erstellen: Europarecht Anwendbarkeit Vorrang Vorabentscheidung; Spezial Hausarbeiten Fristen Form Und Zustaendigk... |
| `europarecht-interessen-fertigen-sonderfall-fuehrt` | Spezial Europarecht Mehrparteien Konflikt Und Interessen, Spezial Fertigen Sonderfall Und Edge Case, Spezial Fuehrt Risikoampel Und Gegenargumente: Spezial Europarecht Mehrparteien Konflikt Und Interessen; Spezial Fertigen Sonderfall Und... |
| `gutachtenstil-vs-haus-fussnotenstil-literaturrecherche-leitfaden` | Gutachtenstil Vs Urteilsstil, Haus Fussnotenstil Spezial, Haus Literaturrecherche Leitfaden: Gutachtenstil Vs Urteilsstil; Haus Fussnotenstil Spezial; Haus Literaturrecherche Leitfaden. Führt Intake, Prüfroutine, Normen-/Quellenradar, Be... |
| `haus-plagiatscheck-haus-themaeingrenzung-meinungsstreit` | Haus Plagiatscheck Eigenstaendigkeit Spezial, Haus Themaeingrenzung Bauleiter, Meinungsstreit Darstellen: Haus Plagiatscheck Eigenstaendigkeit Spezial; Haus Themaeingrenzung Bauleiter; Meinungsstreit Darstellen. Führt Intake, Prüfroutine... |
| `juristische-liefert-beweislast-rechtstheorie` | Spezial Juristische Tatbestand Beweis Und Belege, Spezial Liefert Beweislast Und Darlegungslast, Spezial Rechtstheorie Internationaler Bezug Und Schnittstellen: Spezial Juristische Tatbestand Beweis Und Belege; Spezial Liefert Beweislast... |
| `methodenlehre-auslegung-oeffentliches-statthaft-professor` | Methodenlehre Auslegung, Oeffentliches Recht Statthaft Zulaessig Begruendet, Professor Erkennen Und Strategie: Methodenlehre Auslegung; Oeffentliches Recht Statthaft Zulaessig Begruendet; Professor Erkennen Und Strategie. Führt Intake, P... |
| `rechtstheorie-rechtsphilosophie-seminararbeit-modus-adressaten` | Rechtstheorie Rechtsphilosophie Anbindung, Seminararbeit Modus, Spezial Adressaten Formular Portal Und Einreichung: Rechtstheorie Rechtsphilosophie Anbindung; Seminararbeit Modus; Spezial Adressaten Formular Portal Und Einreichung. Führt... |
| `schleimerei-seminararbeiten-sokratisch` | Spezial Schleimerei Mandantenkommunikation Entscheidungsvorlage, Spezial Seminararbeiten Dokumentenmatrix Und Lueckenliste, Spezial Sokratisch Behörden Gericht Und Registerweg: Spezial Schleimerei Mandantenkommunikation Entscheidungsvorl... |
...
| `strafrecht-zivilrecht-strafrecht-rechtswidrigkeit` | Spezial Strafrecht Zahlen Schwellen Und Berechnung, Spezial Zivilrecht Verhandlung Vergleich Und Eskalation, Strafrecht Tatbestand Rechtswidrigkeit Schuld: Spezial Strafrecht Zahlen Schwellen Und Berechnung; Spezial Zivilrecht Verhandlun... |
| `subsumtion-schritt-verfassungsrecht-grundrechtspruefung` | Subsumtion Schritt Für Schritt, Verfassungsrecht Grundrechtspruefung, Zitierweise Jura Fundstellen: Subsumtion Schritt Für Schritt; Verfassungsrecht Grundrechtspruefung; Zitierweise Jura Fundstellen. Führt Intake, Prüfroutine, Normen-/Qu... |
...
| `workflow-fristen-workflow-redteam-quellenrecherche` | Workflow Fristen Und Risikoampel, Workflow Redteam Qualitygate, Quellenrecherche Rechtsprechung Literatur: Workflow Fristen Und Risikoampel; Workflow Redteam Qualitygate; Quellenrecherche Rechtsprechung Literatur. Führt Intake, Prüfrouti... |
...
| `zivilrecht-anspruchsgrundlagen` | Zivilrecht Anspruchsgrundlagen Prüfung: Zivilrecht Anspruchsgrundlagen Prüfung. Führt Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck zusammen. |
