...
- **Fehlende Tatsache vs. fehlender Beleg.** Bei Jura-Hausarbeiten oft fehlend: Sachverhalt, Literaturverzeichnis, Gliederung.
- **Pro Lücke.** Beweisthema, Beweismittel (Urkunde, Zeuge), Beschaffungsweg, Ersatznachweis.
- **Prioritätsregel.** Frist > Beweislast > materielle Voraussetzung > Taktik; konkret: Hausarbeits-Abgabefrist.
- **Beschaffung extern.** Universitäre Prüfungsämter (Akteneinsicht, Auskunft), Mandant (Originale), Dritte (Auskunftsverlangen).
- **Lücken offen ausweisen** im Mandantenmemo — niemals durch Pauschalformulierungen kaschieren.

## Output

Priorisierte Lückenliste mit Frist, Beweiszweck, Beschaffungsweg, Ersatznachweis und Verantwortlichem; im Mandat Jura-Hausarbeiten typischerweise Sachverhalt, Literaturverzeichnis zuerst.
