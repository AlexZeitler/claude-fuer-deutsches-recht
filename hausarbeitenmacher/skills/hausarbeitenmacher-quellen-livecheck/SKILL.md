...
- **Tragende Normen amtlich.** Bei Jura-Hausarbeiten: BGB AT/BT, StGB AT/BT, GG, ZPO/StPO/VwGO — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** Universitäre Prüfungsämter (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
