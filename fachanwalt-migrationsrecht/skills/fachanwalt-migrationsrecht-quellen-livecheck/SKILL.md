---
name: fachanwalt-migrationsrecht-quellen-livecheck
...
- **Tragende Normen amtlich.** Bei Fachanwalt Migrationsrecht: AufenthG, FreizügG/EU, AsylG, StAG, Aufenthaltsverordnung, EU-Familienzusammenführungs-RL — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** Ausländerbehörde (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
