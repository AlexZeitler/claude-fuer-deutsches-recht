---
name: zwangsvollstreckung-quellen-livecheck
...
- **Tragende Normen amtlich.** Bei Zwangsvollstreckung: ZPO §§ 704-945 (Vollstreckung), GVGA, InsO — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** Vollstreckungsgericht (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
