---
name: bav-strategie-konzern-quellen-livecheck
...
- **Tragende Normen amtlich.** Bei Betriebliche Altersversorgung im Konzern: BetrAVG, § 1 BetrAVG Zusage, § 16 BetrAVG Anpassung — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** BaFin (PSV) (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
