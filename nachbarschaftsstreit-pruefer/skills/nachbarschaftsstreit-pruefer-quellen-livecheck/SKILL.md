---
name: nachbarschaftsstreit-pruefer-quellen-livecheck
...
- **Tragende Normen amtlich.** Bei Nachbarschaftsstreit: BGB §§ 906, 1004, Landesnachbarrechtsgesetze, BauO Länder — gesetze-im-internet, Eur-Lex oder amtliche Datenbank.
- **Behördenpraxis.** Amtsgericht (Bescheide, Auslegungserlasse, FAQ); Stand-Datum prüfen.
