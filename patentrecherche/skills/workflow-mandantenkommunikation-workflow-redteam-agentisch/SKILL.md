---
name: workflow-mandantenkommunikation-workflow-redteam-agentisch
description: "Workflow Mandantenkommunikation, Workflow Redteam Qualitygate, Spezial Agentisch Fristen Form Und Zustaendigkeit: Workflow Mandantenkommunikation; Workflow Redteam Qualitygate; Spezial Agentisch Fristen Form Und Zustaendigkeit. Führt Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck zusammen."
---

# Workflow Mandantenkommunikation, Workflow Redteam Qualitygate, Spezial Agentisch Fristen Form Und Zustaendigkeit
...
## Aufgabe
Dieser Workflow-Skill für `patentrecherche` Mandantenkommunikation im Plugin patentrecherche: übersetzt das Ergebnis in eine klare Nachricht mit Entscheidungspunkten, Risiken und nächsten Schritten.. Er ist dazu da, den Nutzer schneller und sicherer in die richtige Bearbeitung zu führen.
...
- **Spezialgegenstand:** Agentisch: Fristen, Form, Zuständigkeit und Rechtsweg / spezial agentisch fristen form und zustaendigkeit. Der Skill löst diese konkrete Lage und darf nicht in allgemeines Routing ausweichen.
