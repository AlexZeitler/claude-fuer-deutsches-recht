---
name: nda-abgleich-unterlagen-luecken
...
- **Fehlende Tatsache vs. fehlender Beleg.** Bei NDA-Abgleich oft fehlend: NDA-Entwurf, Mustervorlage, Vorvertrags-Korrespondenz.
- **Pro Lücke.** Beweisthema, Beweismittel (Versionsverlauf, Mailverkehr), Beschaffungsweg, Ersatznachweis.
- **Prioritätsregel.** Frist > Beweislast > materielle Voraussetzung > Taktik; konkret: Geltungsdauer NDA (5-10 Jahre).
