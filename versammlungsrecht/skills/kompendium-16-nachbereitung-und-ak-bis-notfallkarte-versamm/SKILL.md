---
name: kompendium-16-nachbereitung-und-ak-bis-notfallkarte-versamm
description: "versammlungsrecht: eigenständiger Arbeits-Skill für verwandte Arbeitsmodule zu Nachbereitung Und Aktenvermerk, Notfallkarte Versammlungstag; mit Intake, Prüfroutine, Normen-/Quellenradar, Beweislogik, Outputmuster und Qualitätscheck."
---

# Arbeitsbereich - Nachbereitung Und Aktenvermerk, Notfallkarte Versammlungstag
...
## 1. `nachbereitung-und-aktenvermerk`

**Fokus:** Erstellt Nachbereitung nach Durchführung, Auflagenproblemen, Polizeikontakt, Presse und möglichem Folgeverfahren.
...
## 2. `notfallkarte-versammlungstag`

**Fokus:** Erstellt eine kompakte Notfallkarte für Leitung, Stellvertretung, Ordner und Dokumentationsteam.
