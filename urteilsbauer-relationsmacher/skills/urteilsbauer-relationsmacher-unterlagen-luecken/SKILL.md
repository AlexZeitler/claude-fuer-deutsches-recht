---
name: urteilsbauer-relationsmacher-unterlagen-luecken
...
- **Fehlende Tatsache vs. fehlender Beleg.** Bei Urteilsbauer/Relationsmacher oft fehlend: Klage, Klageerwiderung, Beweisaufnahme.
- **Pro Lücke.** Beweisthema, Beweismittel (Beweisaufnahme-Ergebnis), Beschaffungsweg, Ersatznachweis.
- **Prioritätsregel.** Frist > Beweislast > materielle Voraussetzung > Taktik; konkret: Verkündung.
...
Priorisierte Lückenliste mit Frist, Beweiszweck, Beschaffungsweg, Ersatznachweis und Verantwortlichem; im Mandat Urteilsbauer/Relationsmacher typischerweise Klage, Klageerwiderung zuerst.
